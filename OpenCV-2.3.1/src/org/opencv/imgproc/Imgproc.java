...
public class Imgproc {
    ...
    public static void Canny(Mat image, Mat edges, double threshold1, double threshold2, int apertureSize, boolean L2gradient)
    {
        ...
        n_Canny(image.nativeObj, edges.nativeObj, threshold1, threshold2, apertureSize, L2gradient);
    ...
    public static void Canny(Mat image, Mat edges, double threshold1, double threshold2, int apertureSize)
    {
        ...
        n_Canny(image.nativeObj, edges.nativeObj, threshold1, threshold2, apertureSize);
    ...
    public static void Canny(Mat image, Mat edges, double threshold1, double threshold2)
    {
        ...
        n_Canny(image.nativeObj, edges.nativeObj, threshold1, threshold2);
    ...
    public static void GaussianBlur(Mat src, Mat dst, Size ksize, double sigma1, double sigma2, int borderType)
    {
        ...
        n_GaussianBlur(src.nativeObj, dst.nativeObj, ksize.width, ksize.height, sigma1, sigma2, borderType);
    ...
    public static void GaussianBlur(Mat src, Mat dst, Size ksize, double sigma1, double sigma2)
    {
        ...
        n_GaussianBlur(src.nativeObj, dst.nativeObj, ksize.width, ksize.height, sigma1, sigma2);
    ...
    public static void GaussianBlur(Mat src, Mat dst, Size ksize, double sigma1)
    {
        ...
        n_GaussianBlur(src.nativeObj, dst.nativeObj, ksize.width, ksize.height, sigma1);
    ...
    public static void HoughCircles(Mat image, Mat circles, int method, double dp, double minDist, double param1, double param2, int minRadius, int maxRadius)
    {
        ...
        n_HoughCircles(image.nativeObj, circles.nativeObj, method, dp, minDist, param1, param2, minRadius, maxRadius);
    ...
    public static void HoughCircles(Mat image, Mat circles, int method, double dp, double minDist, double param1, double param2, int minRadius)
    {
        ...
        n_HoughCircles(image.nativeObj, circles.nativeObj, method, dp, minDist, param1, param2, minRadius);
    ...
    public static void HoughCircles(Mat image, Mat circles, int method, double dp, double minDist, double param1, double param2)
    {
        ...
        n_HoughCircles(image.nativeObj, circles.nativeObj, method, dp, minDist, param1, param2);
    ...
    public static void HoughCircles(Mat image, Mat circles, int method, double dp, double minDist, double param1)
    {
        ...
        n_HoughCircles(image.nativeObj, circles.nativeObj, method, dp, minDist, param1);
    ...
    public static void HoughCircles(Mat image, Mat circles, int method, double dp, double minDist)
    {
        ...
        n_HoughCircles(image.nativeObj, circles.nativeObj, method, dp, minDist);
    ...
    public static void HoughLines(Mat image, Mat lines, double rho, double theta, int threshold, double srn, double stn)
    {
        ...
        n_HoughLines(image.nativeObj, lines.nativeObj, rho, theta, threshold, srn, stn);
    ...
    public static void HoughLines(Mat image, Mat lines, double rho, double theta, int threshold, double srn)
    {
        ...
        n_HoughLines(image.nativeObj, lines.nativeObj, rho, theta, threshold, srn);
    ...
    public static void HoughLines(Mat image, Mat lines, double rho, double theta, int threshold)
    {
        ...
        n_HoughLines(image.nativeObj, lines.nativeObj, rho, theta, threshold);
    ...
    public static void HoughLinesP(Mat image, Mat lines, double rho, double theta, int threshold, double minLineLength, double maxLineGap)
    {
        ...
        n_HoughLinesP(image.nativeObj, lines.nativeObj, rho, theta, threshold, minLineLength, maxLineGap);
    ...
    public static void HoughLinesP(Mat image, Mat lines, double rho, double theta, int threshold, double minLineLength)
    {
        ...
        n_HoughLinesP(image.nativeObj, lines.nativeObj, rho, theta, threshold, minLineLength);
    ...
    public static void HoughLinesP(Mat image, Mat lines, double rho, double theta, int threshold)
    {
        ...
        n_HoughLinesP(image.nativeObj, lines.nativeObj, rho, theta, threshold);
    ...
    public static void HuMoments(Moments m, Mat hu)
    {
        ...
        n_HuMoments(m.nativeObj, hu.nativeObj);
    ...
    public static void Laplacian(Mat src, Mat dst, int ddepth, int ksize, double scale, double delta, int borderType)
    {
        ...
        n_Laplacian(src.nativeObj, dst.nativeObj, ddepth, ksize, scale, delta, borderType);
    ...
    public static void Laplacian(Mat src, Mat dst, int ddepth, int ksize, double scale, double delta)
    {
        ...
        n_Laplacian(src.nativeObj, dst.nativeObj, ddepth, ksize, scale, delta);
    ...
    public static void Laplacian(Mat src, Mat dst, int ddepth, int ksize, double scale)
    {
        ...
        n_Laplacian(src.nativeObj, dst.nativeObj, ddepth, ksize, scale);
    ...
    public static void Laplacian(Mat src, Mat dst, int ddepth, int ksize)
    {
        ...
        n_Laplacian(src.nativeObj, dst.nativeObj, ddepth, ksize);
    ...
    public static void Laplacian(Mat src, Mat dst, int ddepth)
    {
        ...
        n_Laplacian(src.nativeObj, dst.nativeObj, ddepth);
    ...
    public static void Scharr(Mat src, Mat dst, int ddepth, int dx, int dy, double scale, double delta, int borderType)
    {
        ...
        n_Scharr(src.nativeObj, dst.nativeObj, ddepth, dx, dy, scale, delta, borderType);
    ...
    public static void Scharr(Mat src, Mat dst, int ddepth, int dx, int dy, double scale, double delta)
    {
        ...
        n_Scharr(src.nativeObj, dst.nativeObj, ddepth, dx, dy, scale, delta);
    ...
    public static void Scharr(Mat src, Mat dst, int ddepth, int dx, int dy, double scale)
    {
        ...
        n_Scharr(src.nativeObj, dst.nativeObj, ddepth, dx, dy, scale);
    ...
    public static void Scharr(Mat src, Mat dst, int ddepth, int dx, int dy)
    {
        ...
        n_Scharr(src.nativeObj, dst.nativeObj, ddepth, dx, dy);
    ...
    public static void Sobel(Mat src, Mat dst, int ddepth, int dx, int dy, int ksize, double scale, double delta, int borderType)
    {
        ...
        n_Sobel(src.nativeObj, dst.nativeObj, ddepth, dx, dy, ksize, scale, delta, borderType);
    ...
    public static void Sobel(Mat src, Mat dst, int ddepth, int dx, int dy, int ksize, double scale, double delta)
    {
        ...
        n_Sobel(src.nativeObj, dst.nativeObj, ddepth, dx, dy, ksize, scale, delta);
    ...
    public static void Sobel(Mat src, Mat dst, int ddepth, int dx, int dy, int ksize, double scale)
    {
        ...
        n_Sobel(src.nativeObj, dst.nativeObj, ddepth, dx, dy, ksize, scale);
    ...
    public static void Sobel(Mat src, Mat dst, int ddepth, int dx, int dy, int ksize)
    {
        ...
        n_Sobel(src.nativeObj, dst.nativeObj, ddepth, dx, dy, ksize);
    ...
    public static void Sobel(Mat src, Mat dst, int ddepth, int dx, int dy)
    {
        ...
        n_Sobel(src.nativeObj, dst.nativeObj, ddepth, dx, dy);
    ...
    public static void accumulate(Mat src, Mat dst, Mat mask)
    {
        ...
        n_accumulate(src.nativeObj, dst.nativeObj, mask.nativeObj);
    ...
    public static void accumulate(Mat src, Mat dst)
    {
        ...
        n_accumulate(src.nativeObj, dst.nativeObj);
    ...
    public static void accumulateProduct(Mat src1, Mat src2, Mat dst, Mat mask)
    {
        ...
        n_accumulateProduct(src1.nativeObj, src2.nativeObj, dst.nativeObj, mask.nativeObj);
    ...
    public static void accumulateProduct(Mat src1, Mat src2, Mat dst)
    {
        ...
        n_accumulateProduct(src1.nativeObj, src2.nativeObj, dst.nativeObj);
    ...
    public static void accumulateSquare(Mat src, Mat dst, Mat mask)
    {
        ...
        n_accumulateSquare(src.nativeObj, dst.nativeObj, mask.nativeObj);
    ...
    public static void accumulateSquare(Mat src, Mat dst)
    {
        ...
        n_accumulateSquare(src.nativeObj, dst.nativeObj);
    ...
    public static void accumulateWeighted(Mat src, Mat dst, double alpha, Mat mask)
    {
        ...
        n_accumulateWeighted(src.nativeObj, dst.nativeObj, alpha, mask.nativeObj);
    ...
    public static void accumulateWeighted(Mat src, Mat dst, double alpha)
    {
        ...
        n_accumulateWeighted(src.nativeObj, dst.nativeObj, alpha);
    ...
    public static void adaptiveThreshold(Mat src, Mat dst, double maxValue, int adaptiveMethod, int thresholdType, int blockSize, double C)
    {
        ...
        n_adaptiveThreshold(src.nativeObj, dst.nativeObj, maxValue, adaptiveMethod, thresholdType, blockSize, C);
    ...
    public static void approxPolyDP(Mat curve, Mat approxCurve, double epsilon, boolean closed)
    {
        ...
        n_approxPolyDP(curve.nativeObj, approxCurve.nativeObj, epsilon, closed);
    ...
    //
    // C++:  double arcLength(Mat curve, bool closed)
    //
    ...
    public static double arcLength(Mat curve, boolean closed)
    {
        ...
        double retVal = n_arcLength(curve.nativeObj, closed);
    ...
    public static void bilateralFilter(Mat src, Mat dst, int d, double sigmaColor, double sigmaSpace, int borderType)
    {
        ...
        n_bilateralFilter(src.nativeObj, dst.nativeObj, d, sigmaColor, sigmaSpace, borderType);
    ...
    public static void bilateralFilter(Mat src, Mat dst, int d, double sigmaColor, double sigmaSpace)
    {
        ...
        n_bilateralFilter(src.nativeObj, dst.nativeObj, d, sigmaColor, sigmaSpace);
    ...
    public static void blur(Mat src, Mat dst, Size ksize, Point anchor, int borderType)
    {
        ...
        n_blur(src.nativeObj, dst.nativeObj, ksize.width, ksize.height, anchor.x, anchor.y, borderType);
    ...
    public static void blur(Mat src, Mat dst, Size ksize, Point anchor)
    {
        ...
        n_blur(src.nativeObj, dst.nativeObj, ksize.width, ksize.height, anchor.x, anchor.y);
    ...
    public static void blur(Mat src, Mat dst, Size ksize)
    {
        ...
        n_blur(src.nativeObj, dst.nativeObj, ksize.width, ksize.height);
    ...
    public static int borderInterpolate(int p, int len, int borderType)
    {
        ...
        int retVal = n_borderInterpolate(p, len, borderType);
    ...
    //
    // C++:  Rect boundingRect(Mat points)
    //
     ...
     */
    public static Rect boundingRect(Mat points)
    {

        Rect retVal = new Rect(n_boundingRect(points.nativeObj));
    ...
    public static void boxFilter(Mat src, Mat dst, int ddepth, Size ksize, Point anchor, boolean normalize, int borderType)
    {
        ...
        n_boxFilter(src.nativeObj, dst.nativeObj, ddepth, ksize.width, ksize.height, anchor.x, anchor.y, normalize, borderType);
    ...
    public static void boxFilter(Mat src, Mat dst, int ddepth, Size ksize, Point anchor, boolean normalize)
    {
        ...
        n_boxFilter(src.nativeObj, dst.nativeObj, ddepth, ksize.width, ksize.height, anchor.x, anchor.y, normalize);
    ...
    public static void boxFilter(Mat src, Mat dst, int ddepth, Size ksize, Point anchor)
    {
        ...
        n_boxFilter(src.nativeObj, dst.nativeObj, ddepth, ksize.width, ksize.height, anchor.x, anchor.y);
    ...
    public static void boxFilter(Mat src, Mat dst, int ddepth, Size ksize)
    {
        ...
        n_boxFilter(src.nativeObj, dst.nativeObj, ddepth, ksize.width, ksize.height);
     ...
     */
    public static void calcBackProject(java.util.List<Mat> images, java.util.List<Integer> channels, Mat hist, Mat dst, java.util.List<Float> ranges, double scale)
    {
        Mat images_mat = utils.vector_Mat_to_Mat(images);  Mat channels_mat = utils.vector_int_to_Mat(channels);  Mat ranges_mat = utils.vector_float_to_Mat(ranges);
        n_calcBackProject(images_mat.nativeObj, channels_mat.nativeObj, hist.nativeObj, dst.nativeObj, ranges_mat.nativeObj, scale);
     ...
     */
    public static void calcHist(java.util.List<Mat> images, java.util.List<Integer> channels, Mat mask, Mat hist, java.util.List<Integer> histSize, java.util.List<Float> ranges, boolean accumulate)
    {
        Mat images_mat = utils.vector_Mat_to_Mat(images);  Mat channels_mat = utils.vector_int_to_Mat(channels);  Mat histSize_mat = utils.vector_int_to_Mat(histSize);  Mat ranges_mat = utils.vector_float_to_Mat(ranges);
        n_calcHist(images_mat.nativeObj, channels_mat.nativeObj, mask.nativeObj, hist.nativeObj, histSize_mat.nativeObj, ranges_mat.nativeObj, accumulate);
     ...
     * @see <a href="http://opencv.itseez.com/modules/imgproc/doc/histograms.html#calchist">org.opencv.imgproc.Imgproc.calcHist</a>
     */
    public static void calcHist(java.util.List<Mat> images, java.util.List<Integer> channels, Mat mask, Mat hist, java.util.List<Integer> histSize, java.util.List<Float> ranges)
    {
        Mat images_mat = utils.vector_Mat_to_Mat(images);  Mat channels_mat = utils.vector_int_to_Mat(channels);  Mat histSize_mat = utils.vector_int_to_Mat(histSize);  Mat ranges_mat = utils.vector_float_to_Mat(ranges);
        n_calcHist(images_mat.nativeObj, channels_mat.nativeObj, mask.nativeObj, hist.nativeObj, histSize_mat.nativeObj, ranges_mat.nativeObj);
    ...
    public static double compareHist(Mat H1, Mat H2, int method)
    {
        ...
        double retVal = n_compareHist(H1.nativeObj, H2.nativeObj, method);
    ...
    public static double contourArea(Mat contour, boolean oriented)
    {
        ...
        double retVal = n_contourArea(contour.nativeObj, oriented);
    ...
    public static double contourArea(Mat contour)
    {
        ...
        double retVal = n_contourArea(contour.nativeObj);
    ...
    public static void convertMaps(Mat map1, Mat map2, Mat dstmap1, Mat dstmap2, int dstmap1type, boolean nninterpolation)
    {
        ...
        n_convertMaps(map1.nativeObj, map2.nativeObj, dstmap1.nativeObj, dstmap2.nativeObj, dstmap1type, nninterpolation);
    ...
    public static void convertMaps(Mat map1, Mat map2, Mat dstmap1, Mat dstmap2, int dstmap1type)
    {
        ...
        n_convertMaps(map1.nativeObj, map2.nativeObj, dstmap1.nativeObj, dstmap2.nativeObj, dstmap1type);
    ...
    public static void convexHull(Mat points, Mat hull, boolean clockwise, boolean returnPoints)
    {
        ...
        n_convexHull(points.nativeObj, hull.nativeObj, clockwise, returnPoints);
    ...
    public static void convexHull(Mat points, Mat hull, boolean clockwise)
    {
        ...
        n_convexHull(points.nativeObj, hull.nativeObj, clockwise);
    ...
    public static void convexHull(Mat points, Mat hull)
    {
        ...
        n_convexHull(points.nativeObj, hull.nativeObj);
    ...
    public static void copyMakeBorder(Mat src, Mat dst, int top, int bottom, int left, int right, int borderType, Scalar value)
    {
        ...
        n_copyMakeBorder(src.nativeObj, dst.nativeObj, top, bottom, left, right, borderType, value.val[0], value.val[1], value.val[2], value.val[3]);
    ...
    public static void copyMakeBorder(Mat src, Mat dst, int top, int bottom, int left, int right, int borderType)
    {
        ...
        n_copyMakeBorder(src.nativeObj, dst.nativeObj, top, bottom, left, right, borderType);
    ...
    public static void cornerEigenValsAndVecs(Mat src, Mat dst, int blockSize, int ksize, int borderType)
    {
        ...
        n_cornerEigenValsAndVecs(src.nativeObj, dst.nativeObj, blockSize, ksize, borderType);
    ...
    public static void cornerEigenValsAndVecs(Mat src, Mat dst, int blockSize, int ksize)
    {
        ...
        n_cornerEigenValsAndVecs(src.nativeObj, dst.nativeObj, blockSize, ksize);
    ...
    public static void cornerHarris(Mat src, Mat dst, int blockSize, int ksize, double k, int borderType)
    {
        ...
        n_cornerHarris(src.nativeObj, dst.nativeObj, blockSize, ksize, k, borderType);
    ...
    public static void cornerHarris(Mat src, Mat dst, int blockSize, int ksize, double k)
    {
        ...
        n_cornerHarris(src.nativeObj, dst.nativeObj, blockSize, ksize, k);
    ...
    public static void cornerMinEigenVal(Mat src, Mat dst, int blockSize, int ksize, int borderType)
    {
        ...
        n_cornerMinEigenVal(src.nativeObj, dst.nativeObj, blockSize, ksize, borderType);
    ...
    public static void cornerMinEigenVal(Mat src, Mat dst, int blockSize, int ksize)
    {
        ...
        n_cornerMinEigenVal(src.nativeObj, dst.nativeObj, blockSize, ksize);
    ...
    public static void cornerMinEigenVal(Mat src, Mat dst, int blockSize)
    {
        ...
        n_cornerMinEigenVal(src.nativeObj, dst.nativeObj, blockSize);
    ...
    public static void cornerSubPix(Mat image, Mat corners, Size winSize, Size zeroZone, TermCriteria criteria)
    {
        ...
        n_cornerSubPix(image.nativeObj, corners.nativeObj, winSize.width, winSize.height, zeroZone.width, zeroZone.height, criteria.type, criteria.maxCount, criteria.epsilon);
    ...
    public static void cvtColor(Mat src, Mat dst, int code, int dstCn)
    {
        ...
        n_cvtColor(src.nativeObj, dst.nativeObj, code, dstCn);
    ...
    public static void cvtColor(Mat src, Mat dst, int code)
    {
        ...
        n_cvtColor(src.nativeObj, dst.nativeObj, code);
    ...
    public static void dilate(Mat src, Mat dst, Mat kernel, Point anchor, int iterations, int borderType, Scalar borderValue)
    {
        ...
        n_dilate(src.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.x, anchor.y, iterations, borderType, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
    ...
    public static void dilate(Mat src, Mat dst, Mat kernel, Point anchor, int iterations)
    {
        ...
        n_dilate(src.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.x, anchor.y, iterations);
    ...
    public static void dilate(Mat src, Mat dst, Mat kernel, Point anchor)
    {
        ...
        n_dilate(src.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.x, anchor.y);
    ...
    public static void dilate(Mat src, Mat dst, Mat kernel)
    {
        ...
        n_dilate(src.nativeObj, dst.nativeObj, kernel.nativeObj);
    ...
    public static void distanceTransform(Mat src, Mat dst, Mat labels, int distanceType, int maskSize)
    {
        ...
        n_distanceTransform(src.nativeObj, dst.nativeObj, labels.nativeObj, distanceType, maskSize);
    ...
    {
        Mat contours_mat = utils.vector_Mat_to_Mat(contours);
        n_drawContours(image.nativeObj, contours_mat.nativeObj, contourIdx, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, hierarchy.nativeObj, maxLevel, offset.x, offset.y);
     ...
     * @see <a href="http://opencv.itseez.com/modules/imgproc/doc/structural_analysis_and_shape_descriptors.html#drawcontours">org.opencv.imgproc.Imgproc.drawContours</a>
     */
    public static void drawContours(Mat image, java.util.List<Mat> contours, int contourIdx, Scalar color, int thickness, int lineType, Mat hierarchy, int maxLevel)
    {
        Mat contours_mat = utils.vector_Mat_to_Mat(contours);
        n_drawContours(image.nativeObj, contours_mat.nativeObj, contourIdx, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, hierarchy.nativeObj, maxLevel);
     ...
     * @see <a href="http://opencv.itseez.com/modules/imgproc/doc/structural_analysis_and_shape_descriptors.html#drawcontours">org.opencv.imgproc.Imgproc.drawContours</a>
     */
    public static void drawContours(Mat image, java.util.List<Mat> contours, int contourIdx, Scalar color, int thickness, int lineType, Mat hierarchy)
    {
        Mat contours_mat = utils.vector_Mat_to_Mat(contours);
        n_drawContours(image.nativeObj, contours_mat.nativeObj, contourIdx, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, hierarchy.nativeObj);
     ...
     * @see <a href="http://opencv.itseez.com/modules/imgproc/doc/structural_analysis_and_shape_descriptors.html#drawcontours">org.opencv.imgproc.Imgproc.drawContours</a>
     */
    public static void drawContours(Mat image, java.util.List<Mat> contours, int contourIdx, Scalar color, int thickness, int lineType)
    {
        Mat contours_mat = utils.vector_Mat_to_Mat(contours);
        n_drawContours(image.nativeObj, contours_mat.nativeObj, contourIdx, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType);
     ...
     * @see <a href="http://opencv.itseez.com/modules/imgproc/doc/structural_analysis_and_shape_descriptors.html#drawcontours">org.opencv.imgproc.Imgproc.drawContours</a>
     */
    public static void drawContours(Mat image, java.util.List<Mat> contours, int contourIdx, Scalar color, int thickness)
    {
        Mat contours_mat = utils.vector_Mat_to_Mat(contours);
        n_drawContours(image.nativeObj, contours_mat.nativeObj, contourIdx, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
     ...
     * @see <a href="http://opencv.itseez.com/modules/imgproc/doc/structural_analysis_and_shape_descriptors.html#drawcontours">org.opencv.imgproc.Imgproc.drawContours</a>
     */
    public static void drawContours(Mat image, java.util.List<Mat> contours, int contourIdx, Scalar color)
    {
        Mat contours_mat = utils.vector_Mat_to_Mat(contours);
        n_drawContours(image.nativeObj, contours_mat.nativeObj, contourIdx, color.val[0], color.val[1], color.val[2], color.val[3]);
    ...
    public static void equalizeHist(Mat src, Mat dst)
    {
        ...
        n_equalizeHist(src.nativeObj, dst.nativeObj);
    ...
    public static void erode(Mat src, Mat dst, Mat kernel, Point anchor, int iterations, int borderType, Scalar borderValue)
    {
        ...
        n_erode(src.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.x, anchor.y, iterations, borderType, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
    ...
    public static void erode(Mat src, Mat dst, Mat kernel, Point anchor, int iterations)
    {
        ...
        n_erode(src.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.x, anchor.y, iterations);
    ...
    public static void erode(Mat src, Mat dst, Mat kernel, Point anchor)
    {
        ...
        n_erode(src.nativeObj, dst.nativeObj, kernel.nativeObj, anchor.x, anchor.y);
    ...
    public static void erode(Mat src, Mat dst, Mat kernel)
    {
        ...
        n_erode(src.nativeObj, dst.nativeObj, kernel.nativeObj);
    ...
    public static void filter2D(Mat src, Mat dst, int ddepth, Mat kernel, Point anchor, double delta, int borderType)
    {
        ...
        n_filter2D(src.nativeObj, dst.nativeObj, ddepth, kernel.nativeObj, anchor.x, anchor.y, delta, borderType);
    ...
    public static void filter2D(Mat src, Mat dst, int ddepth, Mat kernel, Point anchor, double delta)
    {
        ...
        n_filter2D(src.nativeObj, dst.nativeObj, ddepth, kernel.nativeObj, anchor.x, anchor.y, delta);
    ...
    public static void filter2D(Mat src, Mat dst, int ddepth, Mat kernel, Point anchor)
    {
        ...
        n_filter2D(src.nativeObj, dst.nativeObj, ddepth, kernel.nativeObj, anchor.x, anchor.y);
    ...
    public static void filter2D(Mat src, Mat dst, int ddepth, Mat kernel)
    {
        ...
        n_filter2D(src.nativeObj, dst.nativeObj, ddepth, kernel.nativeObj);
     ...
     */
    public static void findContours(Mat image, java.util.List<Mat> contours, Mat hierarchy, int mode, int method, Point offset)
    {
        Mat contours_mat = new Mat();
        n_findContours(image.nativeObj, contours_mat.nativeObj, hierarchy.nativeObj, mode, method, offset.x, offset.y);
        utils.Mat_to_vector_Mat(contours_mat, contours);
        return;
    }
     ...
     * @see <a href="http://opencv.itseez.com/modules/imgproc/doc/structural_analysis_and_shape_descriptors.html#findcontours">org.opencv.imgproc.Imgproc.findContours</a>
     */
    public static void findContours(Mat image, java.util.List<Mat> contours, Mat hierarchy, int mode, int method)
    {
        Mat contours_mat = new Mat();
        n_findContours(image.nativeObj, contours_mat.nativeObj, hierarchy.nativeObj, mode, method);
        utils.Mat_to_vector_Mat(contours_mat, contours);
        return;
    }
    ...
    //
    // C++:  RotatedRect fitEllipse(Mat points)
    //
    ...
    public static RotatedRect fitEllipse(Mat points)
    {
        ...
        RotatedRect retVal = new RotatedRect(n_fitEllipse(points.nativeObj));
    ...
    public static void fitLine(Mat points, Mat line, int distType, double param, double reps, double aeps)
    {
        ...
        n_fitLine(points.nativeObj, line.nativeObj, distType, param, reps, aeps);
    ...
    {
        double[] rect_out = new double[4];
        int retVal = n_floodFill(image.nativeObj, mask.nativeObj, seedPoint.x, seedPoint.y, newVal.val[0], newVal.val[1], newVal.val[2], newVal.val[3], rect_out, loDiff.val[0], loDiff.val[1], loDiff.val[2], loDiff.val[3], upDiff.val[0], upDiff.val[1], upDiff.val[2], upDiff.val[3]);
        rect.x = (int)rect_out[0]; rect.y = (int)rect_out[1]; rect.width = (int)rect_out[2]; rect.height = (int)rect_out[3];
        return retVal;
    }
    ...
    {
        double[] rect_out = new double[4];
        int retVal = n_floodFill(image.nativeObj, mask.nativeObj, seedPoint.x, seedPoint.y, newVal.val[0], newVal.val[1], newVal.val[2], newVal.val[3], rect_out, loDiff.val[0], loDiff.val[1], loDiff.val[2], loDiff.val[3]);
        rect.x = (int)rect_out[0]; rect.y = (int)rect_out[1]; rect.width = (int)rect_out[2]; rect.height = (int)rect_out[3];
        return retVal;
    }
    ...
    {
        double[] rect_out = new double[4];
        int retVal = n_floodFill(image.nativeObj, mask.nativeObj, seedPoint.x, seedPoint.y, newVal.val[0], newVal.val[1], newVal.val[2], newVal.val[3], rect_out);
        rect.x = (int)rect_out[0]; rect.y = (int)rect_out[1]; rect.width = (int)rect_out[2]; rect.height = (int)rect_out[3];
        return retVal;
    }
    ...
    public static int floodFill(Mat image, Mat mask, Point seedPoint, Scalar newVal)
    {
        ...
        int retVal = n_floodFill(image.nativeObj, mask.nativeObj, seedPoint.x, seedPoint.y, newVal.val[0], newVal.val[1], newVal.val[2], newVal.val[3]);
    ...
    //
    // C++:  Mat getAffineTransform(Mat src, Mat dst)
    //
    ...
    public static Mat getAffineTransform(Mat src, Mat dst)
    {
        ...
        Mat retVal = new Mat(n_getAffineTransform(src.nativeObj, dst.nativeObj));
    ...
    public static Mat getDefaultNewCameraMatrix(Mat cameraMatrix, Size imgsize, boolean centerPrincipalPoint)
    {
        ...
        Mat retVal = new Mat(n_getDefaultNewCameraMatrix(cameraMatrix.nativeObj, imgsize.width, imgsize.height, centerPrincipalPoint));
    ...
    public static Mat getDefaultNewCameraMatrix(Mat cameraMatrix, Size imgsize)
    {
        ...
        Mat retVal = new Mat(n_getDefaultNewCameraMatrix(cameraMatrix.nativeObj, imgsize.width, imgsize.height));
    ...
    public static Mat getDefaultNewCameraMatrix(Mat cameraMatrix)
    {
        ...
        Mat retVal = new Mat(n_getDefaultNewCameraMatrix(cameraMatrix.nativeObj));
    ...
    public static void getDerivKernels(Mat kx, Mat ky, int dx, int dy, int ksize, boolean normalize, int ktype)
    {
        ...
        n_getDerivKernels(kx.nativeObj, ky.nativeObj, dx, dy, ksize, normalize, ktype);
    ...
    public static void getDerivKernels(Mat kx, Mat ky, int dx, int dy, int ksize, boolean normalize)
    {
        ...
        n_getDerivKernels(kx.nativeObj, ky.nativeObj, dx, dy, ksize, normalize);
    ...
    public static void getDerivKernels(Mat kx, Mat ky, int dx, int dy, int ksize)
    {
        ...
        n_getDerivKernels(kx.nativeObj, ky.nativeObj, dx, dy, ksize);
    ...
    public static Mat getGaussianKernel(int ksize, double sigma, int ktype)
    {
        ...
        Mat retVal = new Mat(n_getGaussianKernel(ksize, sigma, ktype));
    ...
    public static Mat getGaussianKernel(int ksize, double sigma)
    {
        ...
        Mat retVal = new Mat(n_getGaussianKernel(ksize, sigma));
    ...
    public static Mat getPerspectiveTransform(Mat src, Mat dst)
    {
        ...
        Mat retVal = new Mat(n_getPerspectiveTransform(src.nativeObj, dst.nativeObj));
    ...
    public static void getRectSubPix(Mat image, Size patchSize, Point center, Mat patch, int patchType)
    {
        ...
        n_getRectSubPix(image.nativeObj, patchSize.width, patchSize.height, center.x, center.y, patch.nativeObj, patchType);
    ...
    public static void getRectSubPix(Mat image, Size patchSize, Point center, Mat patch)
    {
        ...
        n_getRectSubPix(image.nativeObj, patchSize.width, patchSize.height, center.x, center.y, patch.nativeObj);
    ...
    public static Mat getRotationMatrix2D(Point center, double angle, double scale)
    {
        ...
        Mat retVal = new Mat(n_getRotationMatrix2D(center.x, center.y, angle, scale));
    ...
    public static Mat getStructuringElement(int shape, Size ksize, Point anchor)
    {
        ...
        Mat retVal = new Mat(n_getStructuringElement(shape, ksize.width, ksize.height, anchor.x, anchor.y));
    ...
    public static Mat getStructuringElement(int shape, Size ksize)
    {
        ...
        Mat retVal = new Mat(n_getStructuringElement(shape, ksize.width, ksize.height));
    ...
    //
    // C++:  void goodFeaturesToTrack(Mat image, Mat& corners, int maxCorners, double qualityLevel, double minDistance, Mat mask = Mat(), int blockSize = 3, bool useHarrisDetector = false, double k = 0.04)
    //
     ...
     */
    public static void goodFeaturesToTrack(Mat image, Mat corners, int maxCorners, double qualityLevel, double minDistance, Mat mask, int blockSize, boolean useHarrisDetector, double k)
    {

        n_goodFeaturesToTrack(image.nativeObj, corners.nativeObj, maxCorners, qualityLevel, minDistance, mask.nativeObj, blockSize, useHarrisDetector, k);
     ...
     * @see PlanarObjectDetector
     */
    public static void goodFeaturesToTrack(Mat image, Mat corners, int maxCorners, double qualityLevel, double minDistance, Mat mask, int blockSize, boolean useHarrisDetector)
    {

        n_goodFeaturesToTrack(image.nativeObj, corners.nativeObj, maxCorners, qualityLevel, minDistance, mask.nativeObj, blockSize, useHarrisDetector);
     ...
     * @see PlanarObjectDetector
     */
    public static void goodFeaturesToTrack(Mat image, Mat corners, int maxCorners, double qualityLevel, double minDistance, Mat mask, int blockSize)
    {

        n_goodFeaturesToTrack(image.nativeObj, corners.nativeObj, maxCorners, qualityLevel, minDistance, mask.nativeObj, blockSize);
     ...
     * @see PlanarObjectDetector
     */
    public static void goodFeaturesToTrack(Mat image, Mat corners, int maxCorners, double qualityLevel, double minDistance, Mat mask)
    {

        n_goodFeaturesToTrack(image.nativeObj, corners.nativeObj, maxCorners, qualityLevel, minDistance, mask.nativeObj);
     ...
     * @see PlanarObjectDetector
     */
    public static void goodFeaturesToTrack(Mat image, Mat corners, int maxCorners, double qualityLevel, double minDistance)
    {

        n_goodFeaturesToTrack(image.nativeObj, corners.nativeObj, maxCorners, qualityLevel, minDistance);
    ...
    public static void grabCut(Mat img, Mat mask, Rect rect, Mat bgdModel, Mat fgdModel, int iterCount, int mode)
    {
        ...
        n_grabCut(img.nativeObj, mask.nativeObj, rect.x, rect.y, rect.width, rect.height, bgdModel.nativeObj, fgdModel.nativeObj, iterCount, mode);
    ...
    public static void grabCut(Mat img, Mat mask, Rect rect, Mat bgdModel, Mat fgdModel, int iterCount)
    {
        ...
        n_grabCut(img.nativeObj, mask.nativeObj, rect.x, rect.y, rect.width, rect.height, bgdModel.nativeObj, fgdModel.nativeObj, iterCount);
    ...
    public static void initUndistortRectifyMap(Mat cameraMatrix, Mat distCoeffs, Mat R, Mat newCameraMatrix, Size size, int m1type, Mat map1, Mat map2)
    {
        ...
        n_initUndistortRectifyMap(cameraMatrix.nativeObj, distCoeffs.nativeObj, R.nativeObj, newCameraMatrix.nativeObj, size.width, size.height, m1type, map1.nativeObj, map2.nativeObj);
    ...
    public static float initWideAngleProjMap(Mat cameraMatrix, Mat distCoeffs, Size imageSize, int destImageWidth, int m1type, Mat map1, Mat map2, int projType, double alpha)
    {
        ...
        float retVal = n_initWideAngleProjMap(cameraMatrix.nativeObj, distCoeffs.nativeObj, imageSize.width, imageSize.height, destImageWidth, m1type, map1.nativeObj, map2.nativeObj, projType, alpha);
    ...
    public static float initWideAngleProjMap(Mat cameraMatrix, Mat distCoeffs, Size imageSize, int destImageWidth, int m1type, Mat map1, Mat map2, int projType)
    {
        ...
        float retVal = n_initWideAngleProjMap(cameraMatrix.nativeObj, distCoeffs.nativeObj, imageSize.width, imageSize.height, destImageWidth, m1type, map1.nativeObj, map2.nativeObj, projType);
    ...
    public static float initWideAngleProjMap(Mat cameraMatrix, Mat distCoeffs, Size imageSize, int destImageWidth, int m1type, Mat map1, Mat map2)
    {
        ...
        float retVal = n_initWideAngleProjMap(cameraMatrix.nativeObj, distCoeffs.nativeObj, imageSize.width, imageSize.height, destImageWidth, m1type, map1.nativeObj, map2.nativeObj);
    ...
    public static void inpaint(Mat src, Mat inpaintMask, Mat dst, double inpaintRange, int flags)
    {
        ...
        n_inpaint(src.nativeObj, inpaintMask.nativeObj, dst.nativeObj, inpaintRange, flags);
    ...
    public static void integral(Mat src, Mat sum, int sdepth)
    {
        ...
        n_integral(src.nativeObj, sum.nativeObj, sdepth);
    ...
    public static void integral(Mat src, Mat sum)
    {
        ...
        n_integral(src.nativeObj, sum.nativeObj);
    ...
    public static void integral2(Mat src, Mat sum, Mat sqsum, int sdepth)
    {
        ...
        n_integral2(src.nativeObj, sum.nativeObj, sqsum.nativeObj, sdepth);
    ...
    public static void integral2(Mat src, Mat sum, Mat sqsum)
    {
        ...
        n_integral2(src.nativeObj, sum.nativeObj, sqsum.nativeObj);
    ...
    public static void integral3(Mat src, Mat sum, Mat sqsum, Mat tilted, int sdepth)
    {
        ...
        n_integral3(src.nativeObj, sum.nativeObj, sqsum.nativeObj, tilted.nativeObj, sdepth);
    ...
    public static void integral3(Mat src, Mat sum, Mat sqsum, Mat tilted)
    {
        ...
        n_integral3(src.nativeObj, sum.nativeObj, sqsum.nativeObj, tilted.nativeObj);
    ...
    public static void invertAffineTransform(Mat M, Mat iM)
    {
        ...
        n_invertAffineTransform(M.nativeObj, iM.nativeObj);
    ...
    //
    // C++:  bool isContourConvex(Mat contour)
    //
    ...
    public static boolean isContourConvex(Mat contour)
    {
        ...
        boolean retVal = n_isContourConvex(contour.nativeObj);
    ...
    public static double matchShapes(Mat contour1, Mat contour2, int method, double parameter)
    {
        ...
        double retVal = n_matchShapes(contour1.nativeObj, contour2.nativeObj, method, parameter);
    ...
    public static void matchTemplate(Mat image, Mat templ, Mat result, int method)
    {
        ...
        n_matchTemplate(image.nativeObj, templ.nativeObj, result.nativeObj, method);
    ...
    public static void medianBlur(Mat src, Mat dst, int ksize)
    {
        ...
        n_medianBlur(src.nativeObj, dst.nativeObj, ksize);
    ...
    //
    // C++:  RotatedRect minAreaRect(Mat points)
    //
    ...
    public static RotatedRect minAreaRect(Mat points)
    {
        ...
        RotatedRect retVal = new RotatedRect(n_minAreaRect(points.nativeObj));
    ...
    //
    // C++:  void minEnclosingCircle(Mat points, Point2f center, float radius)
    //
     ...
     */
    public static void minEnclosingCircle(Mat points, Point center, float radius)
    {

        n_minEnclosingCircle(points.nativeObj, center.x, center.y, radius);
    ...
    public static Moments moments(Mat array, boolean binaryImage)
    {
        ...
        Moments retVal = new Moments(n_moments(array.nativeObj, binaryImage));
    ...
    public static Moments moments(Mat array)
    {
        ...
        Moments retVal = new Moments(n_moments(array.nativeObj));
    ...
    public static void morphologyEx(Mat src, Mat dst, int op, Mat kernel, Point anchor, int iterations, int borderType, Scalar borderValue)
    {
        ...
        n_morphologyEx(src.nativeObj, dst.nativeObj, op, kernel.nativeObj, anchor.x, anchor.y, iterations, borderType, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
    ...
    public static void morphologyEx(Mat src, Mat dst, int op, Mat kernel, Point anchor, int iterations)
    {
        ...
        n_morphologyEx(src.nativeObj, dst.nativeObj, op, kernel.nativeObj, anchor.x, anchor.y, iterations);
    ...
    public static void morphologyEx(Mat src, Mat dst, int op, Mat kernel, Point anchor)
    {
        ...
        n_morphologyEx(src.nativeObj, dst.nativeObj, op, kernel.nativeObj, anchor.x, anchor.y);
    ...
    public static void morphologyEx(Mat src, Mat dst, int op, Mat kernel)
    {
        ...
        n_morphologyEx(src.nativeObj, dst.nativeObj, op, kernel.nativeObj);
    ...
    //
    // C++:  double pointPolygonTest(Mat contour, Point2f pt, bool measureDist)
    //
     ...
     */
    public static double pointPolygonTest(Mat contour, Point pt, boolean measureDist)
    {

        double retVal = n_pointPolygonTest(contour.nativeObj, pt.x, pt.y, measureDist);
    ...
    public static void preCornerDetect(Mat src, Mat dst, int ksize, int borderType)
    {
        ...
        n_preCornerDetect(src.nativeObj, dst.nativeObj, ksize, borderType);
    ...
    public static void preCornerDetect(Mat src, Mat dst, int ksize)
    {
        ...
        n_preCornerDetect(src.nativeObj, dst.nativeObj, ksize);
    ...
    public static void pyrDown(Mat src, Mat dst, Size dstsize)
    {
        ...
        n_pyrDown(src.nativeObj, dst.nativeObj, dstsize.width, dstsize.height);
    ...
    public static void pyrDown(Mat src, Mat dst)
    {
        ...
        n_pyrDown(src.nativeObj, dst.nativeObj);
    ...
    public static void pyrMeanShiftFiltering(Mat src, Mat dst, double sp, double sr, int maxLevel, TermCriteria termcrit)
    {
        ...
        n_pyrMeanShiftFiltering(src.nativeObj, dst.nativeObj, sp, sr, maxLevel, termcrit.type, termcrit.maxCount, termcrit.epsilon);
    ...
    public static void pyrMeanShiftFiltering(Mat src, Mat dst, double sp, double sr, int maxLevel)
    {
        ...
        n_pyrMeanShiftFiltering(src.nativeObj, dst.nativeObj, sp, sr, maxLevel);
    ...
    public static void pyrMeanShiftFiltering(Mat src, Mat dst, double sp, double sr)
    {
        ...
        n_pyrMeanShiftFiltering(src.nativeObj, dst.nativeObj, sp, sr);
    ...
    public static void pyrUp(Mat src, Mat dst, Size dstsize)
    {
        ...
        n_pyrUp(src.nativeObj, dst.nativeObj, dstsize.width, dstsize.height);
    ...
    public static void pyrUp(Mat src, Mat dst)
    {
        ...
        n_pyrUp(src.nativeObj, dst.nativeObj);
    ...
    public static void remap(Mat src, Mat dst, Mat map1, Mat map2, int interpolation, int borderMode, Scalar borderValue)
    {
        ...
        n_remap(src.nativeObj, dst.nativeObj, map1.nativeObj, map2.nativeObj, interpolation, borderMode, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
    ...
    public static void remap(Mat src, Mat dst, Mat map1, Mat map2, int interpolation, int borderMode)
    {
        ...
        n_remap(src.nativeObj, dst.nativeObj, map1.nativeObj, map2.nativeObj, interpolation, borderMode);
    ...
    public static void remap(Mat src, Mat dst, Mat map1, Mat map2, int interpolation)
    {
        ...
        n_remap(src.nativeObj, dst.nativeObj, map1.nativeObj, map2.nativeObj, interpolation);
    ...
    public static void resize(Mat src, Mat dst, Size dsize, double fx, double fy, int interpolation)
    {
        ...
        n_resize(src.nativeObj, dst.nativeObj, dsize.width, dsize.height, fx, fy, interpolation);
    ...
    public static void resize(Mat src, Mat dst, Size dsize, double fx, double fy)
    {
        ...
        n_resize(src.nativeObj, dst.nativeObj, dsize.width, dsize.height, fx, fy);
    ...
    public static void resize(Mat src, Mat dst, Size dsize, double fx)
    {
        ...
        n_resize(src.nativeObj, dst.nativeObj, dsize.width, dsize.height, fx);
    ...
    public static void resize(Mat src, Mat dst, Size dsize)
    {
        ...
        n_resize(src.nativeObj, dst.nativeObj, dsize.width, dsize.height);
    ...
    public static void sepFilter2D(Mat src, Mat dst, int ddepth, Mat kernelX, Mat kernelY, Point anchor, double delta, int borderType)
    {
        ...
        n_sepFilter2D(src.nativeObj, dst.nativeObj, ddepth, kernelX.nativeObj, kernelY.nativeObj, anchor.x, anchor.y, delta, borderType);
    ...
    public static void sepFilter2D(Mat src, Mat dst, int ddepth, Mat kernelX, Mat kernelY, Point anchor, double delta)
    {
        ...
        n_sepFilter2D(src.nativeObj, dst.nativeObj, ddepth, kernelX.nativeObj, kernelY.nativeObj, anchor.x, anchor.y, delta);
    ...
    public static void sepFilter2D(Mat src, Mat dst, int ddepth, Mat kernelX, Mat kernelY, Point anchor)
    {
        ...
        n_sepFilter2D(src.nativeObj, dst.nativeObj, ddepth, kernelX.nativeObj, kernelY.nativeObj, anchor.x, anchor.y);
    ...
    public static void sepFilter2D(Mat src, Mat dst, int ddepth, Mat kernelX, Mat kernelY)
    {
        ...
        n_sepFilter2D(src.nativeObj, dst.nativeObj, ddepth, kernelX.nativeObj, kernelY.nativeObj);
    ...
    public static double threshold(Mat src, Mat dst, double thresh, double maxval, int type)
    {
        ...
        double retVal = n_threshold(src.nativeObj, dst.nativeObj, thresh, maxval, type);
    ...
    public static void undistort(Mat src, Mat dst, Mat cameraMatrix, Mat distCoeffs, Mat newCameraMatrix)
    {
        ...
        n_undistort(src.nativeObj, dst.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj, newCameraMatrix.nativeObj);
    ...
    public static void undistort(Mat src, Mat dst, Mat cameraMatrix, Mat distCoeffs)
    {
        ...
        n_undistort(src.nativeObj, dst.nativeObj, cameraMatrix.nativeObj, distCoeffs.nativeObj);
    ...
    public static void warpAffine(Mat src, Mat dst, Mat M, Size dsize, int flags, int borderMode, Scalar borderValue)
    {
        ...
        n_warpAffine(src.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height, flags, borderMode, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
    ...
    public static void warpAffine(Mat src, Mat dst, Mat M, Size dsize, int flags, int borderMode)
    {
        ...
        n_warpAffine(src.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height, flags, borderMode);
    ...
    public static void warpAffine(Mat src, Mat dst, Mat M, Size dsize, int flags)
    {
        ...
        n_warpAffine(src.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height, flags);
    ...
    public static void warpAffine(Mat src, Mat dst, Mat M, Size dsize)
    {
        ...
        n_warpAffine(src.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height);
    ...
    public static void warpPerspective(Mat src, Mat dst, Mat M, Size dsize, int flags, int borderMode, Scalar borderValue)
    {
        ...
        n_warpPerspective(src.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height, flags, borderMode, borderValue.val[0], borderValue.val[1], borderValue.val[2], borderValue.val[3]);
    ...
    public static void warpPerspective(Mat src, Mat dst, Mat M, Size dsize, int flags, int borderMode)
    {
        ...
        n_warpPerspective(src.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height, flags, borderMode);
    ...
    public static void warpPerspective(Mat src, Mat dst, Mat M, Size dsize, int flags)
    {
        ...
        n_warpPerspective(src.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height, flags);
    ...
    public static void warpPerspective(Mat src, Mat dst, Mat M, Size dsize)
    {
        ...
        n_warpPerspective(src.nativeObj, dst.nativeObj, M.nativeObj, dsize.width, dsize.height);
     ...
     * marker-based segmentation algorithm, described in [Meyer92]. Before passing
     * the image to the function, you have to roughly outline the desired regions in
     * the image "markers" with positive (>0) indices. So, every region is
     * represented as one or more connected components with the pixel values 1, 2,
     * 3, and so on. Such markers can be retrieved from a binary mask using
     * "findContours" and "drawContours" (see the "watershed.cpp" demo).
     ...
     *
     * Note: Every two neighbor connected components are not necessarily separated
     * by a watershed boundary (-1's pixels); for example, when such tangent
     * components exist in the initial marker image. Visual demonstration and usage
     * example of the function can be found in the OpenCV samples directory (see the
     * "watershed.cpp" demo).
     *
    ...
    public static void watershed(Mat image, Mat markers)
    {
        ...
        n_watershed(image.nativeObj, markers.nativeObj);
    ...
    // C++:  void Canny(Mat image, Mat& edges, double threshold1, double threshold2, int apertureSize = 3, bool L2gradient = false)
    private static native void n_Canny(long image_nativeObj, long edges_nativeObj, double threshold1, double threshold2, int apertureSize, boolean L2gradient);
    private static native void n_Canny(long image_nativeObj, long edges_nativeObj, double threshold1, double threshold2, int apertureSize);
    private static native void n_Canny(long image_nativeObj, long edges_nativeObj, double threshold1, double threshold2);

    // C++:  void GaussianBlur(Mat src, Mat& dst, Size ksize, double sigma1, double sigma2 = 0, int borderType = BORDER_DEFAULT)
    private static native void n_GaussianBlur(long src_nativeObj, long dst_nativeObj, double ksize_width, double ksize_height, double sigma1, double sigma2, int borderType);
    private static native void n_GaussianBlur(long src_nativeObj, long dst_nativeObj, double ksize_width, double ksize_height, double sigma1, double sigma2);
    private static native void n_GaussianBlur(long src_nativeObj, long dst_nativeObj, double ksize_width, double ksize_height, double sigma1);

    // C++:  void HoughCircles(Mat image, Mat& circles, int method, double dp, double minDist, double param1 = 100, double param2 = 100, int minRadius = 0, int maxRadius = 0)
    private static native void n_HoughCircles(long image_nativeObj, long circles_nativeObj, int method, double dp, double minDist, double param1, double param2, int minRadius, int maxRadius);
    private static native void n_HoughCircles(long image_nativeObj, long circles_nativeObj, int method, double dp, double minDist, double param1, double param2, int minRadius);
    private static native void n_HoughCircles(long image_nativeObj, long circles_nativeObj, int method, double dp, double minDist, double param1, double param2);
    private static native void n_HoughCircles(long image_nativeObj, long circles_nativeObj, int method, double dp, double minDist, double param1);
    private static native void n_HoughCircles(long image_nativeObj, long circles_nativeObj, int method, double dp, double minDist);

    // C++:  void HoughLines(Mat image, Mat& lines, double rho, double theta, int threshold, double srn = 0, double stn = 0)
    private static native void n_HoughLines(long image_nativeObj, long lines_nativeObj, double rho, double theta, int threshold, double srn, double stn);
    private static native void n_HoughLines(long image_nativeObj, long lines_nativeObj, double rho, double theta, int threshold, double srn);
    private static native void n_HoughLines(long image_nativeObj, long lines_nativeObj, double rho, double theta, int threshold);

    // C++:  void HoughLinesP(Mat image, Mat& lines, double rho, double theta, int threshold, double minLineLength = 0, double maxLineGap = 0)
    private static native void n_HoughLinesP(long image_nativeObj, long lines_nativeObj, double rho, double theta, int threshold, double minLineLength, double maxLineGap);
    private static native void n_HoughLinesP(long image_nativeObj, long lines_nativeObj, double rho, double theta, int threshold, double minLineLength);
    private static native void n_HoughLinesP(long image_nativeObj, long lines_nativeObj, double rho, double theta, int threshold);

    // C++:  void HuMoments(Moments m, Mat& hu)
    private static native void n_HuMoments(long m_nativeObj, long hu_nativeObj);

    // C++:  void Laplacian(Mat src, Mat& dst, int ddepth, int ksize = 1, double scale = 1, double delta = 0, int borderType = BORDER_DEFAULT)
    private static native void n_Laplacian(long src_nativeObj, long dst_nativeObj, int ddepth, int ksize, double scale, double delta, int borderType);
    private static native void n_Laplacian(long src_nativeObj, long dst_nativeObj, int ddepth, int ksize, double scale, double delta);
    private static native void n_Laplacian(long src_nativeObj, long dst_nativeObj, int ddepth, int ksize, double scale);
    private static native void n_Laplacian(long src_nativeObj, long dst_nativeObj, int ddepth, int ksize);
    private static native void n_Laplacian(long src_nativeObj, long dst_nativeObj, int ddepth);

    // C++:  void Scharr(Mat src, Mat& dst, int ddepth, int dx, int dy, double scale = 1, double delta = 0, int borderType = BORDER_DEFAULT)
    private static native void n_Scharr(long src_nativeObj, long dst_nativeObj, int ddepth, int dx, int dy, double scale, double delta, int borderType);
    private static native void n_Scharr(long src_nativeObj, long dst_nativeObj, int ddepth, int dx, int dy, double scale, double delta);
    private static native void n_Scharr(long src_nativeObj, long dst_nativeObj, int ddepth, int dx, int dy, double scale);
    private static native void n_Scharr(long src_nativeObj, long dst_nativeObj, int ddepth, int dx, int dy);

    // C++:  void Sobel(Mat src, Mat& dst, int ddepth, int dx, int dy, int ksize = 3, double scale = 1, double delta = 0, int borderType = BORDER_DEFAULT)
    private static native void n_Sobel(long src_nativeObj, long dst_nativeObj, int ddepth, int dx, int dy, int ksize, double scale, double delta, int borderType);
    private static native void n_Sobel(long src_nativeObj, long dst_nativeObj, int ddepth, int dx, int dy, int ksize, double scale, double delta);
    private static native void n_Sobel(long src_nativeObj, long dst_nativeObj, int ddepth, int dx, int dy, int ksize, double scale);
    private static native void n_Sobel(long src_nativeObj, long dst_nativeObj, int ddepth, int dx, int dy, int ksize);
    private static native void n_Sobel(long src_nativeObj, long dst_nativeObj, int ddepth, int dx, int dy);

    // C++:  void accumulate(Mat src, Mat& dst, Mat mask = Mat())
    private static native void n_accumulate(long src_nativeObj, long dst_nativeObj, long mask_nativeObj);
    private static native void n_accumulate(long src_nativeObj, long dst_nativeObj);

    // C++:  void accumulateProduct(Mat src1, Mat src2, Mat& dst, Mat mask = Mat())
    private static native void n_accumulateProduct(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, long mask_nativeObj);
    private static native void n_accumulateProduct(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj);

    // C++:  void accumulateSquare(Mat src, Mat& dst, Mat mask = Mat())
    private static native void n_accumulateSquare(long src_nativeObj, long dst_nativeObj, long mask_nativeObj);
    private static native void n_accumulateSquare(long src_nativeObj, long dst_nativeObj);

    // C++:  void accumulateWeighted(Mat src, Mat& dst, double alpha, Mat mask = Mat())
    private static native void n_accumulateWeighted(long src_nativeObj, long dst_nativeObj, double alpha, long mask_nativeObj);
    private static native void n_accumulateWeighted(long src_nativeObj, long dst_nativeObj, double alpha);

    // C++:  void adaptiveThreshold(Mat src, Mat& dst, double maxValue, int adaptiveMethod, int thresholdType, int blockSize, double C)
    private static native void n_adaptiveThreshold(long src_nativeObj, long dst_nativeObj, double maxValue, int adaptiveMethod, int thresholdType, int blockSize, double C);

    // C++:  void approxPolyDP(Mat curve, Mat& approxCurve, double epsilon, bool closed)
    private static native void n_approxPolyDP(long curve_nativeObj, long approxCurve_nativeObj, double epsilon, boolean closed);

    // C++:  double arcLength(Mat curve, bool closed)
    private static native double n_arcLength(long curve_nativeObj, boolean closed);

    // C++:  void bilateralFilter(Mat src, Mat& dst, int d, double sigmaColor, double sigmaSpace, int borderType = BORDER_DEFAULT)
    private static native void n_bilateralFilter(long src_nativeObj, long dst_nativeObj, int d, double sigmaColor, double sigmaSpace, int borderType);
    private static native void n_bilateralFilter(long src_nativeObj, long dst_nativeObj, int d, double sigmaColor, double sigmaSpace);

    // C++:  void blur(Mat src, Mat& dst, Size ksize, Point anchor = Point(-1,-1), int borderType = BORDER_DEFAULT)
    private static native void n_blur(long src_nativeObj, long dst_nativeObj, double ksize_width, double ksize_height, double anchor_x, double anchor_y, int borderType);
    private static native void n_blur(long src_nativeObj, long dst_nativeObj, double ksize_width, double ksize_height, double anchor_x, double anchor_y);
    private static native void n_blur(long src_nativeObj, long dst_nativeObj, double ksize_width, double ksize_height);

    // C++:  int borderInterpolate(int p, int len, int borderType)
    private static native int n_borderInterpolate(int p, int len, int borderType);

    // C++:  Rect boundingRect(Mat points)
    private static native double[] n_boundingRect(long points_nativeObj);

    // C++:  void boxFilter(Mat src, Mat& dst, int ddepth, Size ksize, Point anchor = Point(-1,-1), bool normalize = true, int borderType = BORDER_DEFAULT)
    private static native void n_boxFilter(long src_nativeObj, long dst_nativeObj, int ddepth, double ksize_width, double ksize_height, double anchor_x, double anchor_y, boolean normalize, int borderType);
    private static native void n_boxFilter(long src_nativeObj, long dst_nativeObj, int ddepth, double ksize_width, double ksize_height, double anchor_x, double anchor_y, boolean normalize);
    private static native void n_boxFilter(long src_nativeObj, long dst_nativeObj, int ddepth, double ksize_width, double ksize_height, double anchor_x, double anchor_y);
    private static native void n_boxFilter(long src_nativeObj, long dst_nativeObj, int ddepth, double ksize_width, double ksize_height);

    // C++:  void calcBackProject(vector_Mat images, vector_int channels, Mat hist, Mat& dst, vector_float ranges, double scale)
    private static native void n_calcBackProject(long images_mat_nativeObj, long channels_mat_nativeObj, long hist_nativeObj, long dst_nativeObj, long ranges_mat_nativeObj, double scale);

    // C++:  void calcHist(vector_Mat images, vector_int channels, Mat mask, Mat& hist, vector_int histSize, vector_float ranges, bool accumulate = false)
    private static native void n_calcHist(long images_mat_nativeObj, long channels_mat_nativeObj, long mask_nativeObj, long hist_nativeObj, long histSize_mat_nativeObj, long ranges_mat_nativeObj, boolean accumulate);
    private static native void n_calcHist(long images_mat_nativeObj, long channels_mat_nativeObj, long mask_nativeObj, long hist_nativeObj, long histSize_mat_nativeObj, long ranges_mat_nativeObj);

    // C++:  double compareHist(Mat H1, Mat H2, int method)
    private static native double n_compareHist(long H1_nativeObj, long H2_nativeObj, int method);

    // C++:  double contourArea(Mat contour, bool oriented = false)
    private static native double n_contourArea(long contour_nativeObj, boolean oriented);
    private static native double n_contourArea(long contour_nativeObj);

    // C++:  void convertMaps(Mat map1, Mat map2, Mat& dstmap1, Mat& dstmap2, int dstmap1type, bool nninterpolation = false)
    private static native void n_convertMaps(long map1_nativeObj, long map2_nativeObj, long dstmap1_nativeObj, long dstmap2_nativeObj, int dstmap1type, boolean nninterpolation);
    private static native void n_convertMaps(long map1_nativeObj, long map2_nativeObj, long dstmap1_nativeObj, long dstmap2_nativeObj, int dstmap1type);

    // C++:  void convexHull(Mat points, Mat& hull, bool clockwise = false, bool returnPoints = true)
    private static native void n_convexHull(long points_nativeObj, long hull_nativeObj, boolean clockwise, boolean returnPoints);
    private static native void n_convexHull(long points_nativeObj, long hull_nativeObj, boolean clockwise);
    private static native void n_convexHull(long points_nativeObj, long hull_nativeObj);

    // C++:  void copyMakeBorder(Mat src, Mat& dst, int top, int bottom, int left, int right, int borderType, Scalar value = Scalar())
    private static native void n_copyMakeBorder(long src_nativeObj, long dst_nativeObj, int top, int bottom, int left, int right, int borderType, double value_val0, double value_val1, double value_val2, double value_val3);
    private static native void n_copyMakeBorder(long src_nativeObj, long dst_nativeObj, int top, int bottom, int left, int right, int borderType);

    // C++:  void cornerEigenValsAndVecs(Mat src, Mat& dst, int blockSize, int ksize, int borderType = BORDER_DEFAULT)
    private static native void n_cornerEigenValsAndVecs(long src_nativeObj, long dst_nativeObj, int blockSize, int ksize, int borderType);
    private static native void n_cornerEigenValsAndVecs(long src_nativeObj, long dst_nativeObj, int blockSize, int ksize);

    // C++:  void cornerHarris(Mat src, Mat& dst, int blockSize, int ksize, double k, int borderType = BORDER_DEFAULT)
    private static native void n_cornerHarris(long src_nativeObj, long dst_nativeObj, int blockSize, int ksize, double k, int borderType);
    private static native void n_cornerHarris(long src_nativeObj, long dst_nativeObj, int blockSize, int ksize, double k);

    // C++:  void cornerMinEigenVal(Mat src, Mat& dst, int blockSize, int ksize = 3, int borderType = BORDER_DEFAULT)
    private static native void n_cornerMinEigenVal(long src_nativeObj, long dst_nativeObj, int blockSize, int ksize, int borderType);
    private static native void n_cornerMinEigenVal(long src_nativeObj, long dst_nativeObj, int blockSize, int ksize);
    private static native void n_cornerMinEigenVal(long src_nativeObj, long dst_nativeObj, int blockSize);

    // C++:  void cornerSubPix(Mat image, Mat& corners, Size winSize, Size zeroZone, TermCriteria criteria)
    private static native void n_cornerSubPix(long image_nativeObj, long corners_nativeObj, double winSize_width, double winSize_height, double zeroZone_width, double zeroZone_height, int criteria_type, int criteria_maxCount, double criteria_epsilon);

    // C++:  void cvtColor(Mat src, Mat& dst, int code, int dstCn = 0)
    private static native void n_cvtColor(long src_nativeObj, long dst_nativeObj, int code, int dstCn);
    private static native void n_cvtColor(long src_nativeObj, long dst_nativeObj, int code);

    // C++:  void dilate(Mat src, Mat& dst, Mat kernel, Point anchor = Point(-1,-1), int iterations = 1, int borderType = BORDER_CONSTANT, Scalar borderValue = morphologyDefaultBorderValue())
    private static native void n_dilate(long src_nativeObj, long dst_nativeObj, long kernel_nativeObj, double anchor_x, double anchor_y, int iterations, int borderType, double borderValue_val0, double borderValue_val1, double borderValue_val2, double borderValue_val3);
    private static native void n_dilate(long src_nativeObj, long dst_nativeObj, long kernel_nativeObj, double anchor_x, double anchor_y, int iterations, int borderType);
    private static native void n_dilate(long src_nativeObj, long dst_nativeObj, long kernel_nativeObj, double anchor_x, double anchor_y, int iterations);
    private static native void n_dilate(long src_nativeObj, long dst_nativeObj, long kernel_nativeObj, double anchor_x, double anchor_y);
    private static native void n_dilate(long src_nativeObj, long dst_nativeObj, long kernel_nativeObj);

    // C++:  void distanceTransform(Mat src, Mat& dst, Mat& labels, int distanceType, int maskSize)
    private static native void n_distanceTransform(long src_nativeObj, long dst_nativeObj, long labels_nativeObj, int distanceType, int maskSize);

    // C++:  void drawContours(Mat& image, vector_Mat contours, int contourIdx, Scalar color, int thickness = 1, int lineType = 8, Mat hierarchy = Mat(), int maxLevel = INT_MAX, Point offset = Point())
    private static native void n_drawContours(long image_nativeObj, long contours_mat_nativeObj, int contourIdx, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, long hierarchy_nativeObj, int maxLevel, double offset_x, double offset_y);
    private static native void n_drawContours(long image_nativeObj, long contours_mat_nativeObj, int contourIdx, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, long hierarchy_nativeObj, int maxLevel);
    private static native void n_drawContours(long image_nativeObj, long contours_mat_nativeObj, int contourIdx, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, long hierarchy_nativeObj);
    private static native void n_drawContours(long image_nativeObj, long contours_mat_nativeObj, int contourIdx, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType);
    private static native void n_drawContours(long image_nativeObj, long contours_mat_nativeObj, int contourIdx, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
    private static native void n_drawContours(long image_nativeObj, long contours_mat_nativeObj, int contourIdx, double color_val0, double color_val1, double color_val2, double color_val3);

    // C++:  void equalizeHist(Mat src, Mat& dst)
    private static native void n_equalizeHist(long src_nativeObj, long dst_nativeObj);

    // C++:  void erode(Mat src, Mat& dst, Mat kernel, Point anchor = Point(-1,-1), int iterations = 1, int borderType = BORDER_CONSTANT, Scalar borderValue = morphologyDefaultBorderValue())
    private static native void n_erode(long src_nativeObj, long dst_nativeObj, long kernel_nativeObj, double anchor_x, double anchor_y, int iterations, int borderType, double borderValue_val0, double borderValue_val1, double borderValue_val2, double borderValue_val3);
    private static native void n_erode(long src_nativeObj, long dst_nativeObj, long kernel_nativeObj, double anchor_x, double anchor_y, int iterations, int borderType);
    private static native void n_erode(long src_nativeObj, long dst_nativeObj, long kernel_nativeObj, double anchor_x, double anchor_y, int iterations);
    private static native void n_erode(long src_nativeObj, long dst_nativeObj, long kernel_nativeObj, double anchor_x, double anchor_y);
    private static native void n_erode(long src_nativeObj, long dst_nativeObj, long kernel_nativeObj);

    // C++:  void filter2D(Mat src, Mat& dst, int ddepth, Mat kernel, Point anchor = Point(-1,-1), double delta = 0, int borderType = BORDER_DEFAULT)
    private static native void n_filter2D(long src_nativeObj, long dst_nativeObj, int ddepth, long kernel_nativeObj, double anchor_x, double anchor_y, double delta, int borderType);
    private static native void n_filter2D(long src_nativeObj, long dst_nativeObj, int ddepth, long kernel_nativeObj, double anchor_x, double anchor_y, double delta);
    private static native void n_filter2D(long src_nativeObj, long dst_nativeObj, int ddepth, long kernel_nativeObj, double anchor_x, double anchor_y);
    private static native void n_filter2D(long src_nativeObj, long dst_nativeObj, int ddepth, long kernel_nativeObj);

    // C++:  void findContours(Mat& image, vector_Mat& contours, Mat& hierarchy, int mode, int method, Point offset = Point())
    private static native void n_findContours(long image_nativeObj, long contours_mat_nativeObj, long hierarchy_nativeObj, int mode, int method, double offset_x, double offset_y);
    private static native void n_findContours(long image_nativeObj, long contours_mat_nativeObj, long hierarchy_nativeObj, int mode, int method);

    // C++:  RotatedRect fitEllipse(Mat points)
    private static native double[] n_fitEllipse(long points_nativeObj);

    // C++:  void fitLine(Mat points, Mat& line, int distType, double param, double reps, double aeps)
    private static native void n_fitLine(long points_nativeObj, long line_nativeObj, int distType, double param, double reps, double aeps);
    ...
    private static native int n_floodFill(long image_nativeObj, long mask_nativeObj, double seedPoint_x, double seedPoint_y, double newVal_val0, double newVal_val1, double newVal_val2, double newVal_val3, double[] rect_out, double loDiff_val0, double loDiff_val1, double loDiff_val2, double loDiff_val3);
    private static native int n_floodFill(long image_nativeObj, long mask_nativeObj, double seedPoint_x, double seedPoint_y, double newVal_val0, double newVal_val1, double newVal_val2, double newVal_val3, double[] rect_out);
    private static native int n_floodFill(long image_nativeObj, long mask_nativeObj, double seedPoint_x, double seedPoint_y, double newVal_val0, double newVal_val1, double newVal_val2, double newVal_val3);

    // C++:  Mat getAffineTransform(Mat src, Mat dst)
    private static native long n_getAffineTransform(long src_nativeObj, long dst_nativeObj);

    // C++:  Mat getDefaultNewCameraMatrix(Mat cameraMatrix, Size imgsize = Size(), bool centerPrincipalPoint = false)
    private static native long n_getDefaultNewCameraMatrix(long cameraMatrix_nativeObj, double imgsize_width, double imgsize_height, boolean centerPrincipalPoint);
    private static native long n_getDefaultNewCameraMatrix(long cameraMatrix_nativeObj, double imgsize_width, double imgsize_height);
    private static native long n_getDefaultNewCameraMatrix(long cameraMatrix_nativeObj);

    // C++:  void getDerivKernels(Mat& kx, Mat& ky, int dx, int dy, int ksize, bool normalize = false, int ktype = CV_32F)
    private static native void n_getDerivKernels(long kx_nativeObj, long ky_nativeObj, int dx, int dy, int ksize, boolean normalize, int ktype);
    private static native void n_getDerivKernels(long kx_nativeObj, long ky_nativeObj, int dx, int dy, int ksize, boolean normalize);
    private static native void n_getDerivKernels(long kx_nativeObj, long ky_nativeObj, int dx, int dy, int ksize);

    // C++:  Mat getGaussianKernel(int ksize, double sigma, int ktype = CV_64F)
    private static native long n_getGaussianKernel(int ksize, double sigma, int ktype);
    private static native long n_getGaussianKernel(int ksize, double sigma);

    // C++:  Mat getPerspectiveTransform(Mat src, Mat dst)
    private static native long n_getPerspectiveTransform(long src_nativeObj, long dst_nativeObj);

    // C++:  void getRectSubPix(Mat image, Size patchSize, Point2f center, Mat& patch, int patchType = -1)
    private static native void n_getRectSubPix(long image_nativeObj, double patchSize_width, double patchSize_height, double center_x, double center_y, long patch_nativeObj, int patchType);
    private static native void n_getRectSubPix(long image_nativeObj, double patchSize_width, double patchSize_height, double center_x, double center_y, long patch_nativeObj);

    // C++:  Mat getRotationMatrix2D(Point2f center, double angle, double scale)
    private static native long n_getRotationMatrix2D(double center_x, double center_y, double angle, double scale);

    // C++:  Mat getStructuringElement(int shape, Size ksize, Point anchor = Point(-1,-1))
    private static native long n_getStructuringElement(int shape, double ksize_width, double ksize_height, double anchor_x, double anchor_y);
    private static native long n_getStructuringElement(int shape, double ksize_width, double ksize_height);

    // C++:  void goodFeaturesToTrack(Mat image, Mat& corners, int maxCorners, double qualityLevel, double minDistance, Mat mask = Mat(), int blockSize = 3, bool useHarrisDetector = false, double k = 0.04)
    private static native void n_goodFeaturesToTrack(long image_nativeObj, long corners_nativeObj, int maxCorners, double qualityLevel, double minDistance, long mask_nativeObj, int blockSize, boolean useHarrisDetector, double k);
    private static native void n_goodFeaturesToTrack(long image_nativeObj, long corners_nativeObj, int maxCorners, double qualityLevel, double minDistance, long mask_nativeObj, int blockSize, boolean useHarrisDetector);
    private static native void n_goodFeaturesToTrack(long image_nativeObj, long corners_nativeObj, int maxCorners, double qualityLevel, double minDistance, long mask_nativeObj, int blockSize);
    private static native void n_goodFeaturesToTrack(long image_nativeObj, long corners_nativeObj, int maxCorners, double qualityLevel, double minDistance, long mask_nativeObj);
    private static native void n_goodFeaturesToTrack(long image_nativeObj, long corners_nativeObj, int maxCorners, double qualityLevel, double minDistance);

    // C++:  void grabCut(Mat img, Mat& mask, Rect rect, Mat& bgdModel, Mat& fgdModel, int iterCount, int mode = GC_EVAL)
    private static native void n_grabCut(long img_nativeObj, long mask_nativeObj, int rect_x, int rect_y, int rect_width, int rect_height, long bgdModel_nativeObj, long fgdModel_nativeObj, int iterCount, int mode);
    private static native void n_grabCut(long img_nativeObj, long mask_nativeObj, int rect_x, int rect_y, int rect_width, int rect_height, long bgdModel_nativeObj, long fgdModel_nativeObj, int iterCount);

    // C++:  void initUndistortRectifyMap(Mat cameraMatrix, Mat distCoeffs, Mat R, Mat newCameraMatrix, Size size, int m1type, Mat& map1, Mat& map2)
    private static native void n_initUndistortRectifyMap(long cameraMatrix_nativeObj, long distCoeffs_nativeObj, long R_nativeObj, long newCameraMatrix_nativeObj, double size_width, double size_height, int m1type, long map1_nativeObj, long map2_nativeObj);

    // C++:  float initWideAngleProjMap(Mat cameraMatrix, Mat distCoeffs, Size imageSize, int destImageWidth, int m1type, Mat& map1, Mat& map2, int projType = PROJ_SPHERICAL_EQRECT, double alpha = 0)
    private static native float n_initWideAngleProjMap(long cameraMatrix_nativeObj, long distCoeffs_nativeObj, double imageSize_width, double imageSize_height, int destImageWidth, int m1type, long map1_nativeObj, long map2_nativeObj, int projType, double alpha);
    private static native float n_initWideAngleProjMap(long cameraMatrix_nativeObj, long distCoeffs_nativeObj, double imageSize_width, double imageSize_height, int destImageWidth, int m1type, long map1_nativeObj, long map2_nativeObj, int projType);
    private static native float n_initWideAngleProjMap(long cameraMatrix_nativeObj, long distCoeffs_nativeObj, double imageSize_width, double imageSize_height, int destImageWidth, int m1type, long map1_nativeObj, long map2_nativeObj);

    // C++:  void inpaint(Mat src, Mat inpaintMask, Mat& dst, double inpaintRange, int flags)
    private static native void n_inpaint(long src_nativeObj, long inpaintMask_nativeObj, long dst_nativeObj, double inpaintRange, int flags);

    // C++:  void integral(Mat src, Mat& sum, int sdepth = -1)
    private static native void n_integral(long src_nativeObj, long sum_nativeObj, int sdepth);
    private static native void n_integral(long src_nativeObj, long sum_nativeObj);

    // C++:  void integral(Mat src, Mat& sum, Mat& sqsum, int sdepth = -1)
    private static native void n_integral2(long src_nativeObj, long sum_nativeObj, long sqsum_nativeObj, int sdepth);
    private static native void n_integral2(long src_nativeObj, long sum_nativeObj, long sqsum_nativeObj);

    // C++:  void integral(Mat src, Mat& sum, Mat& sqsum, Mat& tilted, int sdepth = -1)
    private static native void n_integral3(long src_nativeObj, long sum_nativeObj, long sqsum_nativeObj, long tilted_nativeObj, int sdepth);
    private static native void n_integral3(long src_nativeObj, long sum_nativeObj, long sqsum_nativeObj, long tilted_nativeObj);

    // C++:  void invertAffineTransform(Mat M, Mat& iM)
    private static native void n_invertAffineTransform(long M_nativeObj, long iM_nativeObj);

    // C++:  bool isContourConvex(Mat contour)
    private static native boolean n_isContourConvex(long contour_nativeObj);

    // C++:  double matchShapes(Mat contour1, Mat contour2, int method, double parameter)
    private static native double n_matchShapes(long contour1_nativeObj, long contour2_nativeObj, int method, double parameter);

    // C++:  void matchTemplate(Mat image, Mat templ, Mat& result, int method)
    private static native void n_matchTemplate(long image_nativeObj, long templ_nativeObj, long result_nativeObj, int method);

    // C++:  void medianBlur(Mat src, Mat& dst, int ksize)
    private static native void n_medianBlur(long src_nativeObj, long dst_nativeObj, int ksize);

    // C++:  RotatedRect minAreaRect(Mat points)
    private static native double[] n_minAreaRect(long points_nativeObj);

    // C++:  void minEnclosingCircle(Mat points, Point2f center, float radius)
    private static native void n_minEnclosingCircle(long points_nativeObj, double center_x, double center_y, float radius);

    // C++:  Moments moments(Mat array, bool binaryImage = false)
    private static native long n_moments(long array_nativeObj, boolean binaryImage);
    private static native long n_moments(long array_nativeObj);

    // C++:  void morphologyEx(Mat src, Mat& dst, int op, Mat kernel, Point anchor = Point(-1,-1), int iterations = 1, int borderType = BORDER_CONSTANT, Scalar borderValue = morphologyDefaultBorderValue())
    private static native void n_morphologyEx(long src_nativeObj, long dst_nativeObj, int op, long kernel_nativeObj, double anchor_x, double anchor_y, int iterations, int borderType, double borderValue_val0, double borderValue_val1, double borderValue_val2, double borderValue_val3);
    private static native void n_morphologyEx(long src_nativeObj, long dst_nativeObj, int op, long kernel_nativeObj, double anchor_x, double anchor_y, int iterations, int borderType);
    private static native void n_morphologyEx(long src_nativeObj, long dst_nativeObj, int op, long kernel_nativeObj, double anchor_x, double anchor_y, int iterations);
    private static native void n_morphologyEx(long src_nativeObj, long dst_nativeObj, int op, long kernel_nativeObj, double anchor_x, double anchor_y);
    private static native void n_morphologyEx(long src_nativeObj, long dst_nativeObj, int op, long kernel_nativeObj);

    // C++:  double pointPolygonTest(Mat contour, Point2f pt, bool measureDist)
    private static native double n_pointPolygonTest(long contour_nativeObj, double pt_x, double pt_y, boolean measureDist);

    // C++:  void preCornerDetect(Mat src, Mat& dst, int ksize, int borderType = BORDER_DEFAULT)
    private static native void n_preCornerDetect(long src_nativeObj, long dst_nativeObj, int ksize, int borderType);
    private static native void n_preCornerDetect(long src_nativeObj, long dst_nativeObj, int ksize);

    // C++:  void pyrDown(Mat src, Mat& dst, Size dstsize = Size())
    private static native void n_pyrDown(long src_nativeObj, long dst_nativeObj, double dstsize_width, double dstsize_height);
    private static native void n_pyrDown(long src_nativeObj, long dst_nativeObj);

    // C++:  void pyrMeanShiftFiltering(Mat src, Mat& dst, double sp, double sr, int maxLevel = 1, TermCriteria termcrit = TermCriteria( TermCriteria::MAX_ITER+TermCriteria::EPS,5,1))
    private static native void n_pyrMeanShiftFiltering(long src_nativeObj, long dst_nativeObj, double sp, double sr, int maxLevel, int termcrit_type, int termcrit_maxCount, double termcrit_epsilon);
    private static native void n_pyrMeanShiftFiltering(long src_nativeObj, long dst_nativeObj, double sp, double sr, int maxLevel);
    private static native void n_pyrMeanShiftFiltering(long src_nativeObj, long dst_nativeObj, double sp, double sr);

    // C++:  void pyrUp(Mat src, Mat& dst, Size dstsize = Size())
    private static native void n_pyrUp(long src_nativeObj, long dst_nativeObj, double dstsize_width, double dstsize_height);
    private static native void n_pyrUp(long src_nativeObj, long dst_nativeObj);

    // C++:  void remap(Mat src, Mat& dst, Mat map1, Mat map2, int interpolation, int borderMode = BORDER_CONSTANT, Scalar borderValue = Scalar())
    private static native void n_remap(long src_nativeObj, long dst_nativeObj, long map1_nativeObj, long map2_nativeObj, int interpolation, int borderMode, double borderValue_val0, double borderValue_val1, double borderValue_val2, double borderValue_val3);
    private static native void n_remap(long src_nativeObj, long dst_nativeObj, long map1_nativeObj, long map2_nativeObj, int interpolation, int borderMode);
    private static native void n_remap(long src_nativeObj, long dst_nativeObj, long map1_nativeObj, long map2_nativeObj, int interpolation);

    // C++:  void resize(Mat src, Mat& dst, Size dsize, double fx = 0, double fy = 0, int interpolation = INTER_LINEAR)
    private static native void n_resize(long src_nativeObj, long dst_nativeObj, double dsize_width, double dsize_height, double fx, double fy, int interpolation);
    private static native void n_resize(long src_nativeObj, long dst_nativeObj, double dsize_width, double dsize_height, double fx, double fy);
    private static native void n_resize(long src_nativeObj, long dst_nativeObj, double dsize_width, double dsize_height, double fx);
    private static native void n_resize(long src_nativeObj, long dst_nativeObj, double dsize_width, double dsize_height);

    // C++:  void sepFilter2D(Mat src, Mat& dst, int ddepth, Mat kernelX, Mat kernelY, Point anchor = Point(-1,-1), double delta = 0, int borderType = BORDER_DEFAULT)
    private static native void n_sepFilter2D(long src_nativeObj, long dst_nativeObj, int ddepth, long kernelX_nativeObj, long kernelY_nativeObj, double anchor_x, double anchor_y, double delta, int borderType);
    private static native void n_sepFilter2D(long src_nativeObj, long dst_nativeObj, int ddepth, long kernelX_nativeObj, long kernelY_nativeObj, double anchor_x, double anchor_y, double delta);
    private static native void n_sepFilter2D(long src_nativeObj, long dst_nativeObj, int ddepth, long kernelX_nativeObj, long kernelY_nativeObj, double anchor_x, double anchor_y);
    private static native void n_sepFilter2D(long src_nativeObj, long dst_nativeObj, int ddepth, long kernelX_nativeObj, long kernelY_nativeObj);

    // C++:  double threshold(Mat src, Mat& dst, double thresh, double maxval, int type)
    private static native double n_threshold(long src_nativeObj, long dst_nativeObj, double thresh, double maxval, int type);

    // C++:  void undistort(Mat src, Mat& dst, Mat cameraMatrix, Mat distCoeffs, Mat newCameraMatrix = Mat())
    private static native void n_undistort(long src_nativeObj, long dst_nativeObj, long cameraMatrix_nativeObj, long distCoeffs_nativeObj, long newCameraMatrix_nativeObj);
    private static native void n_undistort(long src_nativeObj, long dst_nativeObj, long cameraMatrix_nativeObj, long distCoeffs_nativeObj);

    // C++:  void warpAffine(Mat src, Mat& dst, Mat M, Size dsize, int flags = INTER_LINEAR, int borderMode = BORDER_CONSTANT, Scalar borderValue = Scalar())
    private static native void n_warpAffine(long src_nativeObj, long dst_nativeObj, long M_nativeObj, double dsize_width, double dsize_height, int flags, int borderMode, double borderValue_val0, double borderValue_val1, double borderValue_val2, double borderValue_val3);
    private static native void n_warpAffine(long src_nativeObj, long dst_nativeObj, long M_nativeObj, double dsize_width, double dsize_height, int flags, int borderMode);
    private static native void n_warpAffine(long src_nativeObj, long dst_nativeObj, long M_nativeObj, double dsize_width, double dsize_height, int flags);
    private static native void n_warpAffine(long src_nativeObj, long dst_nativeObj, long M_nativeObj, double dsize_width, double dsize_height);

    // C++:  void warpPerspective(Mat src, Mat& dst, Mat M, Size dsize, int flags = INTER_LINEAR, int borderMode = BORDER_CONSTANT, Scalar borderValue = Scalar())
    private static native void n_warpPerspective(long src_nativeObj, long dst_nativeObj, long M_nativeObj, double dsize_width, double dsize_height, int flags, int borderMode, double borderValue_val0, double borderValue_val1, double borderValue_val2, double borderValue_val3);
    private static native void n_warpPerspective(long src_nativeObj, long dst_nativeObj, long M_nativeObj, double dsize_width, double dsize_height, int flags, int borderMode);
    private static native void n_warpPerspective(long src_nativeObj, long dst_nativeObj, long M_nativeObj, double dsize_width, double dsize_height, int flags);
    private static native void n_warpPerspective(long src_nativeObj, long dst_nativeObj, long M_nativeObj, double dsize_width, double dsize_height);

    // C++:  void watershed(Mat image, Mat& markers)
    private static native void n_watershed(long image_nativeObj, long markers_nativeObj);
