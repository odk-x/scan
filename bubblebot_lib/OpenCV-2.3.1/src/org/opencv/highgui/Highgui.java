...
public class Highgui {
     ...
     * If the buffer is too short or contains invalid data, the empty matrix is
     * returned.
     *
    ...
    public static Mat imdecode(Mat buf, int flags)
    {
        ...
        Mat retVal = new Mat(n_imdecode(buf.nativeObj, flags));
     ...
     */
    public static boolean imencode(java.lang.String ext, Mat img, java.util.List<Byte> buf, java.util.List<Integer> params)
    {
        Mat buf_mat = utils.vector_uchar_to_Mat(buf);  Mat params_mat = utils.vector_int_to_Mat(params);
        boolean retVal = n_imencode(ext, img.nativeObj, buf_mat.nativeObj, params_mat.nativeObj);
     ...
     * @see <a href="http://opencv.itseez.com/modules/highgui/doc/reading_and_writing_images_and_video.html#imencode">org.opencv.highgui.Highgui.imencode</a>
     */
    public static boolean imencode(java.lang.String ext, Mat img, java.util.List<Byte> buf)
    {
        Mat buf_mat = utils.vector_uchar_to_Mat(buf);
        boolean retVal = n_imencode(ext, img.nativeObj, buf_mat.nativeObj);
    ...
    public static Mat imread(java.lang.String filename, int flags)
    {
        ...
        Mat retVal = new Mat(n_imread(filename, flags));
    ...
    public static Mat imread(java.lang.String filename)
    {
        ...
        Mat retVal = new Mat(n_imread(filename));
     ...
     */
    public static boolean imwrite(java.lang.String filename, Mat img, java.util.List<Integer> params)
    {
        Mat params_mat = utils.vector_int_to_Mat(params);
        boolean retVal = n_imwrite(filename, img.nativeObj, params_mat.nativeObj);
    ...
    public static boolean imwrite(java.lang.String filename, Mat img)
    {
        ...
        boolean retVal = n_imwrite(filename, img.nativeObj);
    ...
    // C++:  Mat imdecode(Mat buf, int flags)
    private static native long n_imdecode(long buf_nativeObj, int flags);

    // C++:  bool imencode(string ext, Mat img, vector_uchar buf, vector_int params = vector<int>())
    private static native boolean n_imencode(java.lang.String ext, long img_nativeObj, long buf_mat_nativeObj, long params_mat_nativeObj);
    private static native boolean n_imencode(java.lang.String ext, long img_nativeObj, long buf_mat_nativeObj);

    // C++:  Mat imread(string filename, int flags = 1)
    private static native long n_imread(java.lang.String filename, int flags);
    private static native long n_imread(java.lang.String filename);

    // C++:  bool imwrite(string filename, Mat img, vector_int params = vector<int>())
    private static native boolean n_imwrite(java.lang.String filename, long img_nativeObj, long params_mat_nativeObj);
    private static native boolean n_imwrite(java.lang.String filename, long img_nativeObj);
