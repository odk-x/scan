...
public class Core {
    ...
    public static void LUT(Mat src, Mat lut, Mat dst, int interpolation)
    {
        ...
        n_LUT(src.nativeObj, lut.nativeObj, dst.nativeObj, interpolation);
    ...
    public static void LUT(Mat src, Mat lut, Mat dst)
    {
        ...
        n_LUT(src.nativeObj, lut.nativeObj, dst.nativeObj);
    ...
    public static double Mahalanobis(Mat v1, Mat v2, Mat icovar)
    {
        ...
        double retVal = n_Mahalanobis(v1.nativeObj, v2.nativeObj, icovar.nativeObj);
    ...
    public static void PCABackProject(Mat data, Mat mean, Mat eigenvectors, Mat result)
    {
        ...
        n_PCABackProject(data.nativeObj, mean.nativeObj, eigenvectors.nativeObj, result.nativeObj);
    ...
    public static void PCACompute(Mat data, Mat mean, Mat eigenvectors, int maxComponents)
    {
        ...
        n_PCACompute(data.nativeObj, mean.nativeObj, eigenvectors.nativeObj, maxComponents);
    ...
    public static void PCACompute(Mat data, Mat mean, Mat eigenvectors)
    {
        ...
        n_PCACompute(data.nativeObj, mean.nativeObj, eigenvectors.nativeObj);
    ...
    public static void PCAProject(Mat data, Mat mean, Mat eigenvectors, Mat result)
    {
        ...
        n_PCAProject(data.nativeObj, mean.nativeObj, eigenvectors.nativeObj, result.nativeObj);
    ...
    public static void SVBackSubst(Mat w, Mat u, Mat vt, Mat rhs, Mat dst)
    {
        ...
        n_SVBackSubst(w.nativeObj, u.nativeObj, vt.nativeObj, rhs.nativeObj, dst.nativeObj);
    ...
    public static void SVDecomp(Mat src, Mat w, Mat u, Mat vt, int flags)
    {
        ...
        n_SVDecomp(src.nativeObj, w.nativeObj, u.nativeObj, vt.nativeObj, flags);
    ...
    public static void SVDecomp(Mat src, Mat w, Mat u, Mat vt)
    {
        ...
        n_SVDecomp(src.nativeObj, w.nativeObj, u.nativeObj, vt.nativeObj);
    ...
    public static void absdiff(Mat src1, Mat src2, Mat dst)
    {
        ...
        n_absdiff(src1.nativeObj, src2.nativeObj, dst.nativeObj);
    ...
    public static void add(Mat src1, Mat src2, Mat dst, Mat mask)
    {
        ...
        n_add(src1.nativeObj, src2.nativeObj, dst.nativeObj, mask.nativeObj);
    ...
    public static void add(Mat src1, Mat src2, Mat dst)
    {
        ...
        n_add(src1.nativeObj, src2.nativeObj, dst.nativeObj);
    ...
    public static void addWeighted(Mat src1, double alpha, Mat src2, double beta, double gamma, Mat dst, int dtype)
    {
        ...
        n_addWeighted(src1.nativeObj, alpha, src2.nativeObj, beta, gamma, dst.nativeObj, dtype);
    ...
    public static void addWeighted(Mat src1, double alpha, Mat src2, double beta, double gamma, Mat dst)
    {
        ...
        n_addWeighted(src1.nativeObj, alpha, src2.nativeObj, beta, gamma, dst.nativeObj);
    ...
    public static void bitwise_and(Mat src1, Mat src2, Mat dst, Mat mask)
    {
        ...
        n_bitwise_and(src1.nativeObj, src2.nativeObj, dst.nativeObj, mask.nativeObj);
    ...
    public static void bitwise_and(Mat src1, Mat src2, Mat dst)
    {
        ...
        n_bitwise_and(src1.nativeObj, src2.nativeObj, dst.nativeObj);
    ...
    public static void bitwise_not(Mat src, Mat dst, Mat mask)
    {
        ...
        n_bitwise_not(src.nativeObj, dst.nativeObj, mask.nativeObj);
    ...
    public static void bitwise_not(Mat src, Mat dst)
    {
        ...
        n_bitwise_not(src.nativeObj, dst.nativeObj);
    ...
    public static void bitwise_or(Mat src1, Mat src2, Mat dst, Mat mask)
    {
        ...
        n_bitwise_or(src1.nativeObj, src2.nativeObj, dst.nativeObj, mask.nativeObj);
    ...
    public static void bitwise_or(Mat src1, Mat src2, Mat dst)
    {
        ...
        n_bitwise_or(src1.nativeObj, src2.nativeObj, dst.nativeObj);
    ...
    public static void bitwise_xor(Mat src1, Mat src2, Mat dst, Mat mask)
    {
        ...
        n_bitwise_xor(src1.nativeObj, src2.nativeObj, dst.nativeObj, mask.nativeObj);
    ...
    public static void bitwise_xor(Mat src1, Mat src2, Mat dst)
    {
        ...
        n_bitwise_xor(src1.nativeObj, src2.nativeObj, dst.nativeObj);
    ...
    public static void calcCovarMatrix(Mat samples, Mat covar, Mat mean, int flags, int ctype)
    {
        ...
        n_calcCovarMatrix(samples.nativeObj, covar.nativeObj, mean.nativeObj, flags, ctype);
    ...
    public static void calcCovarMatrix(Mat samples, Mat covar, Mat mean, int flags)
    {
        ...
        n_calcCovarMatrix(samples.nativeObj, covar.nativeObj, mean.nativeObj, flags);
    ...
    public static void cartToPolar(Mat x, Mat y, Mat magnitude, Mat angle, boolean angleInDegrees)
    {
        ...
        n_cartToPolar(x.nativeObj, y.nativeObj, magnitude.nativeObj, angle.nativeObj, angleInDegrees);
    ...
    public static void cartToPolar(Mat x, Mat y, Mat magnitude, Mat angle)
    {
        ...
        n_cartToPolar(x.nativeObj, y.nativeObj, magnitude.nativeObj, angle.nativeObj);
    ...
    public static boolean checkRange(Mat a, boolean quiet, Point pt, double minVal, double maxVal)
    {
        ...
        boolean retVal = n_checkRange(a.nativeObj, quiet, pt_out, minVal, maxVal);
        pt.x = pt_out[0]; pt.y = pt_out[1];
        return retVal;
    }
    ...
    {
        double[] pt_out = new double[2];
        boolean retVal = n_checkRange(a.nativeObj, quiet, pt_out, minVal);
        pt.x = pt_out[0]; pt.y = pt_out[1];
        return retVal;
    }
    ...
    {
        double[] pt_out = new double[2];
        boolean retVal = n_checkRange(a.nativeObj, quiet, pt_out);
        pt.x = pt_out[0]; pt.y = pt_out[1];
        return retVal;
    }
    ...
    public static boolean checkRange(Mat a, boolean quiet)
    {
        ...
        boolean retVal = n_checkRange(a.nativeObj, quiet);
    ...
    public static boolean checkRange(Mat a)
    {
        ...
        boolean retVal = n_checkRange(a.nativeObj);
    ...
    public static void circle(Mat img, Point center, int radius, Scalar color, int thickness, int lineType, int shift)
    {
        ...
        n_circle(img.nativeObj, center.x, center.y, radius, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
    ...
    public static void circle(Mat img, Point center, int radius, Scalar color, int thickness, int lineType)
    {
        ...
        n_circle(img.nativeObj, center.x, center.y, radius, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType);
    ...
    public static void circle(Mat img, Point center, int radius, Scalar color, int thickness)
    {
        ...
        n_circle(img.nativeObj, center.x, center.y, radius, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
    ...
    public static void circle(Mat img, Point center, int radius, Scalar color)
    {
        ...
        n_circle(img.nativeObj, center.x, center.y, radius, color.val[0], color.val[1], color.val[2], color.val[3]);
    ...
    {
        double[] pt1_out = new double[2];  double[] pt2_out = new double[2];
        boolean retVal = n_clipLine(imgRect.x, imgRect.y, imgRect.width, imgRect.height, pt1.x, pt1.y, pt1_out, pt2.x, pt2.y, pt2_out);
        pt1.x = pt1_out[0]; pt1.y = pt1_out[1];   pt2.x = pt2_out[0]; pt2.y = pt2_out[1];
        return retVal;
    }
    ...
    public static void compare(Mat src1, Mat src2, Mat dst, int cmpop)
    {
        ...
        n_compare(src1.nativeObj, src2.nativeObj, dst.nativeObj, cmpop);
    ...
    public static void completeSymm(Mat mtx, boolean lowerToUpper)
    {
        ...
        n_completeSymm(mtx.nativeObj, lowerToUpper);
    ...
    public static void convertScaleAbs(Mat src, Mat dst, double alpha, double beta)
    {
        ...
        n_convertScaleAbs(src.nativeObj, dst.nativeObj, alpha, beta);
    ...
    public static void convertScaleAbs(Mat src, Mat dst, double alpha)
    {
        ...
        n_convertScaleAbs(src.nativeObj, dst.nativeObj, alpha);
    ...
    public static void convertScaleAbs(Mat src, Mat dst)
    {
        ...
        n_convertScaleAbs(src.nativeObj, dst.nativeObj);
    ...
    public static int countNonZero(Mat src)
    {
        ...
        int retVal = n_countNonZero(src.nativeObj);
    ...
    public static void dct(Mat src, Mat dst, int flags)
    {
        ...
        n_dct(src.nativeObj, dst.nativeObj, flags);
    ...
    public static void dct(Mat src, Mat dst)
    {
        ...
        n_dct(src.nativeObj, dst.nativeObj);
    ...
    public static double determinant(Mat mtx)
    {
        ...
        double retVal = n_determinant(mtx.nativeObj);
    ...
    public static void dft(Mat src, Mat dst, int flags, int nonzeroRows)
    {
        ...
        n_dft(src.nativeObj, dst.nativeObj, flags, nonzeroRows);
    ...
    public static void dft(Mat src, Mat dst, int flags)
    {
        ...
        n_dft(src.nativeObj, dst.nativeObj, flags);
    ...
    public static void dft(Mat src, Mat dst)
    {
        ...
        n_dft(src.nativeObj, dst.nativeObj);
    ...
    public static void divide(Mat src1, Mat src2, Mat dst, double scale, int dtype)
    {
        ...
        n_divide(src1.nativeObj, src2.nativeObj, dst.nativeObj, scale, dtype);
    ...
    public static void divide(Mat src1, Mat src2, Mat dst, double scale)
    {
        ...
        n_divide(src1.nativeObj, src2.nativeObj, dst.nativeObj, scale);
    ...
    public static void divide(Mat src1, Mat src2, Mat dst)
    {
        ...
        n_divide(src1.nativeObj, src2.nativeObj, dst.nativeObj);
    ...
    public static void divide(double scale, Mat src2, Mat dst, int dtype)
    {
        ...
        n_divide(scale, src2.nativeObj, dst.nativeObj, dtype);
    ...
    public static void divide(double scale, Mat src2, Mat dst)
    {
        ...
        n_divide(scale, src2.nativeObj, dst.nativeObj);
    ...
    public static boolean eigen(Mat src, boolean computeEigenvectors, Mat eigenvalues, Mat eigenvectors)
    {
        ...
        boolean retVal = n_eigen(src.nativeObj, computeEigenvectors, eigenvalues.nativeObj, eigenvectors.nativeObj);
    ...
    public static void ellipse(Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color, int thickness, int lineType, int shift)
    {
        ...
        n_ellipse(img.nativeObj, center.x, center.y, axes.width, axes.height, angle, startAngle, endAngle, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
    ...
    public static void ellipse(Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color, int thickness, int lineType)
    {
        ...
        n_ellipse(img.nativeObj, center.x, center.y, axes.width, axes.height, angle, startAngle, endAngle, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType);
    ...
    public static void ellipse(Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color, int thickness)
    {
        ...
        n_ellipse(img.nativeObj, center.x, center.y, axes.width, axes.height, angle, startAngle, endAngle, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
    ...
    public static void ellipse(Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color)
    {
        ...
        n_ellipse(img.nativeObj, center.x, center.y, axes.width, axes.height, angle, startAngle, endAngle, color.val[0], color.val[1], color.val[2], color.val[3]);
    ...
    public static void ellipse(Mat img, RotatedRect box, Scalar color, int thickness, int lineType)
    {
        ...
        n_ellipse(img.nativeObj, box.center.x, box.center.y, box.size.width, box.size.height, box.angle, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType);
    ...
    public static void ellipse(Mat img, RotatedRect box, Scalar color, int thickness)
    {
        ...
        n_ellipse(img.nativeObj, box.center.x, box.center.y, box.size.width, box.size.height, box.angle, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
    ...
    public static void ellipse(Mat img, RotatedRect box, Scalar color)
    {
        ...
        n_ellipse(img.nativeObj, box.center.x, box.center.y, box.size.width, box.size.height, box.angle, color.val[0], color.val[1], color.val[2], color.val[3]);
     ...
     */
    public static void ellipse2Poly(Point center, Size axes, int angle, int arcStart, int arcEnd, int delta, java.util.List<Point> pts)
    {
        Mat pts_mat = new Mat();
        n_ellipse2Poly(center.x, center.y, axes.width, axes.height, angle, arcStart, arcEnd, delta, pts_mat.nativeObj);
        utils.Mat_to_vector_Point(pts_mat, pts);
        return;
    }
    ...
    public static void exp(Mat src, Mat dst)
    {
        ...
        n_exp(src.nativeObj, dst.nativeObj);
    ...
    public static void extractChannel(Mat src, Mat dst, int coi)
    {
        ...
        n_extractChannel(src.nativeObj, dst.nativeObj, coi);
    ...
    //
    // C++:  void fillConvexPoly(Mat& img, Mat points, Scalar color, int lineType = 8, int shift = 0)
    //
    ...
    public static void fillConvexPoly(Mat img, Mat points, Scalar color, int lineType, int shift)
    {
        ...
        n_fillConvexPoly(img.nativeObj, points.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3], lineType, shift);
     ...
     * @see <a href="http://opencv.itseez.com/modules/core/doc/drawing_functions.html#fillconvexpoly">org.opencv.core.Core.fillConvexPoly</a>
     */
    public static void fillConvexPoly(Mat img, Mat points, Scalar color, int lineType)
    {

        n_fillConvexPoly(img.nativeObj, points.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3], lineType);
     ...
     * @see <a href="http://opencv.itseez.com/modules/core/doc/drawing_functions.html#fillconvexpoly">org.opencv.core.Core.fillConvexPoly</a>
     */
    public static void fillConvexPoly(Mat img, Mat points, Scalar color)
    {

        n_fillConvexPoly(img.nativeObj, points.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3]);
    ...
    //
    // C++:  void fillPoly(Mat& img, vector_Mat pts, Scalar color, int lineType = 8, int shift = 0, Point offset = Point())
    //
     ...
     */
    public static void fillPoly(Mat img, java.util.List<Mat> pts, Scalar color, int lineType, int shift, Point offset)
    {
        Mat pts_mat = utils.vector_Mat_to_Mat(pts);
        n_fillPoly(img.nativeObj, pts_mat.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3], lineType, shift, offset.x, offset.y);
     ...
     * @see <a href="http://opencv.itseez.com/modules/core/doc/drawing_functions.html#fillpoly">org.opencv.core.Core.fillPoly</a>
     */
    public static void fillPoly(Mat img, java.util.List<Mat> pts, Scalar color, int lineType, int shift)
    {
        Mat pts_mat = utils.vector_Mat_to_Mat(pts);
        n_fillPoly(img.nativeObj, pts_mat.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3], lineType, shift);
     ...
     * @see <a href="http://opencv.itseez.com/modules/core/doc/drawing_functions.html#fillpoly">org.opencv.core.Core.fillPoly</a>
     */
    public static void fillPoly(Mat img, java.util.List<Mat> pts, Scalar color, int lineType)
    {
        Mat pts_mat = utils.vector_Mat_to_Mat(pts);
        n_fillPoly(img.nativeObj, pts_mat.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3], lineType);
     ...
     * @see <a href="http://opencv.itseez.com/modules/core/doc/drawing_functions.html#fillpoly">org.opencv.core.Core.fillPoly</a>
     */
    public static void fillPoly(Mat img, java.util.List<Mat> pts, Scalar color)
    {
        Mat pts_mat = utils.vector_Mat_to_Mat(pts);
        n_fillPoly(img.nativeObj, pts_mat.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3]);
    ...
    public static void flip(Mat src, Mat dst, int flipCode)
    {
        ...
        n_flip(src.nativeObj, dst.nativeObj, flipCode);
    ...
    public static void gemm(Mat src1, Mat src2, double alpha, Mat src3, double gamma, Mat dst, int flags)
    {
        ...
        n_gemm(src1.nativeObj, src2.nativeObj, alpha, src3.nativeObj, gamma, dst.nativeObj, flags);
    ...
    public static void gemm(Mat src1, Mat src2, double alpha, Mat src3, double gamma, Mat dst)
    {
        ...
        n_gemm(src1.nativeObj, src2.nativeObj, alpha, src3.nativeObj, gamma, dst.nativeObj);
    ...
    public static int getOptimalDFTSize(int vecsize)
    {
        ...
        int retVal = n_getOptimalDFTSize(vecsize);
    ...
    public static double getTickFrequency()
    {
        ...
        double retVal = n_getTickFrequency();
    ...
    //
    // C++:  void hconcat(Mat src, Mat& dst)
    //

    public static void hconcat(Mat src, Mat dst)
    {

        n_hconcat(src.nativeObj, dst.nativeObj);
    ...
    public static void idct(Mat src, Mat dst, int flags)
    {
        ...
        n_idct(src.nativeObj, dst.nativeObj, flags);
    ...
    public static void idct(Mat src, Mat dst)
    {
        ...
        n_idct(src.nativeObj, dst.nativeObj);
    ...
    public static void idft(Mat src, Mat dst, int flags, int nonzeroRows)
    {
        ...
        n_idft(src.nativeObj, dst.nativeObj, flags, nonzeroRows);
    ...
    public static void idft(Mat src, Mat dst, int flags)
    {
        ...
        n_idft(src.nativeObj, dst.nativeObj, flags);
    ...
    public static void idft(Mat src, Mat dst)
    {
        ...
        n_idft(src.nativeObj, dst.nativeObj);
    ...
    //
    // C++:  void inRange(Mat src, Mat lowerb, Mat upperb, Mat& dst)
    //
    ...
    public static void inRange(Mat src, Mat lowerb, Mat upperb, Mat dst)
    {
        ...
        n_inRange(src.nativeObj, lowerb.nativeObj, upperb.nativeObj, dst.nativeObj);
    ...
    public static void insertChannel(Mat src, Mat dst, int coi)
    {
        ...
        n_insertChannel(src.nativeObj, dst.nativeObj, coi);
    ...
    public static double invert(Mat src, Mat dst, int flags)
    {
        ...
        double retVal = n_invert(src.nativeObj, dst.nativeObj, flags);
    ...
    public static double invert(Mat src, Mat dst)
    {
        ...
        double retVal = n_invert(src.nativeObj, dst.nativeObj);
    ...
    public static double kmeans(Mat data, int K, Mat bestLabels, TermCriteria criteria, int attempts, int flags, Mat centers)
    {
        ...
        double retVal = n_kmeans(data.nativeObj, K, bestLabels.nativeObj, criteria.type, criteria.maxCount, criteria.epsilon, attempts, flags, centers.nativeObj);
    ...
    public static double kmeans(Mat data, int K, Mat bestLabels, TermCriteria criteria, int attempts, int flags)
    {
        ...
        double retVal = n_kmeans(data.nativeObj, K, bestLabels.nativeObj, criteria.type, criteria.maxCount, criteria.epsilon, attempts, flags);
    ...
    public static void line(Mat img, Point pt1, Point pt2, Scalar color, int thickness, int lineType, int shift)
    {
        ...
        n_line(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
    ...
    public static void line(Mat img, Point pt1, Point pt2, Scalar color, int thickness, int lineType)
    {
        ...
        n_line(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType);
    ...
    public static void line(Mat img, Point pt1, Point pt2, Scalar color, int thickness)
    {
        ...
        n_line(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
    ...
    public static void line(Mat img, Point pt1, Point pt2, Scalar color)
    {
        ...
        n_line(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3]);
    ...
    public static void log(Mat src, Mat dst)
    {
        ...
        n_log(src.nativeObj, dst.nativeObj);
    ...
    public static void magnitude(Mat x, Mat y, Mat magnitude)
    {
        ...
        n_magnitude(x.nativeObj, y.nativeObj, magnitude.nativeObj);
    ...
    public static void max(Mat src1, Mat src2, Mat dst)
    {
        ...
        n_max(src1.nativeObj, src2.nativeObj, dst.nativeObj);
    ...
    public static Scalar mean(Mat src, Mat mask)
    {
        ...
        Scalar retVal = new Scalar(n_mean(src.nativeObj, mask.nativeObj));
    ...
    public static Scalar mean(Mat src)
    {
        ...
        Scalar retVal = new Scalar(n_mean(src.nativeObj));
    ...
    public static void meanStdDev(Mat src, Mat mean, Mat stddev, Mat mask)
    {
        ...
        n_meanStdDev(src.nativeObj, mean.nativeObj, stddev.nativeObj, mask.nativeObj);
    ...
    public static void meanStdDev(Mat src, Mat mean, Mat stddev)
    {
        ...
        n_meanStdDev(src.nativeObj, mean.nativeObj, stddev.nativeObj);
    ...
    {
        Mat mv_mat = utils.vector_Mat_to_Mat(mv);
        n_merge(mv_mat.nativeObj, dst.nativeObj);
    ...
    public static void min(Mat src1, Mat src2, Mat dst)
    {
        ...
        n_min(src1.nativeObj, src2.nativeObj, dst.nativeObj);
     ...
     * where. "fromTo[k*2]" is a 0-based index of the input channel in "srcv".
     * "fromTo[k*2+1]" is an index of the output channel in "dstv". The continuous
     * channel numbering is used: the first input image channels are indexed from
     * "0" to "srcv[0].channels()-1", the second input image channels are indexed
     * from "srcv[0].channels()" to "srcv[0].channels() + srcv[1].channels()-1", and
     * so on. The same scheme is used for the output image channels. As a special
     * case, when "fromTo[k*2]" is negative, the corresponding output channel is
     ...
     */
    public static void mixChannels(java.util.List<Mat> src, java.util.List<Mat> dst, java.util.List<Integer> fromTo)
    {
        Mat src_mat = utils.vector_Mat_to_Mat(src);  Mat dst_mat = utils.vector_Mat_to_Mat(dst);  Mat fromTo_mat = utils.vector_int_to_Mat(fromTo);
        n_mixChannels(src_mat.nativeObj, dst_mat.nativeObj, fromTo_mat.nativeObj);
        utils.Mat_to_vector_Mat(dst_mat, dst);
        return;
    }
    ...
    public static void mulSpectrums(Mat a, Mat b, Mat c, int flags, boolean conjB)
    {
        ...
        n_mulSpectrums(a.nativeObj, b.nativeObj, c.nativeObj, flags, conjB);
    ...
    public static void mulSpectrums(Mat a, Mat b, Mat c, int flags)
    {
        ...
        n_mulSpectrums(a.nativeObj, b.nativeObj, c.nativeObj, flags);
    ...
    public static void mulTransposed(Mat src, Mat dst, boolean aTa, Mat delta, double scale, int dtype)
    {
        ...
        n_mulTransposed(src.nativeObj, dst.nativeObj, aTa, delta.nativeObj, scale, dtype);
    ...
    public static void mulTransposed(Mat src, Mat dst, boolean aTa, Mat delta, double scale)
    {
        ...
        n_mulTransposed(src.nativeObj, dst.nativeObj, aTa, delta.nativeObj, scale);
    ...
    public static void mulTransposed(Mat src, Mat dst, boolean aTa, Mat delta)
    {
        ...
        n_mulTransposed(src.nativeObj, dst.nativeObj, aTa, delta.nativeObj);
    ...
    public static void mulTransposed(Mat src, Mat dst, boolean aTa)
    {
        ...
        n_mulTransposed(src.nativeObj, dst.nativeObj, aTa);
    ...
    public static void multiply(Mat src1, Mat src2, Mat dst, double scale, int dtype)
    {
        ...
        n_multiply(src1.nativeObj, src2.nativeObj, dst.nativeObj, scale, dtype);
    ...
    public static void multiply(Mat src1, Mat src2, Mat dst, double scale)
    {
        ...
        n_multiply(src1.nativeObj, src2.nativeObj, dst.nativeObj, scale);
    ...
    public static void multiply(Mat src1, Mat src2, Mat dst)
    {
        ...
        n_multiply(src1.nativeObj, src2.nativeObj, dst.nativeObj);
    ...
    public static double norm(Mat src1, int normType, Mat mask)
    {
        ...
        double retVal = n_norm(src1.nativeObj, normType, mask.nativeObj);
    ...
    public static double norm(Mat src1, int normType)
    {
        ...
        double retVal = n_norm(src1.nativeObj, normType);
    ...
    public static double norm(Mat src1)
    {
        ...
        double retVal = n_norm(src1.nativeObj);
    ...
    public static double norm(Mat src1, Mat src2, int normType, Mat mask)
    {
        ...
        double retVal = n_norm(src1.nativeObj, src2.nativeObj, normType, mask.nativeObj);
    ...
    public static double norm(Mat src1, Mat src2, int normType)
    {
        ...
        double retVal = n_norm(src1.nativeObj, src2.nativeObj, normType);
    ...
    public static double norm(Mat src1, Mat src2)
    {
        ...
        double retVal = n_norm(src1.nativeObj, src2.nativeObj);
    ...
    public static void normalize(Mat src, Mat dst, double alpha, double beta, int norm_type, int dtype, Mat mask)
    {
        ...
        n_normalize(src.nativeObj, dst.nativeObj, alpha, beta, norm_type, dtype, mask.nativeObj);
    ...
    public static void normalize(Mat src, Mat dst, double alpha, double beta, int norm_type, int dtype)
    {
        ...
        n_normalize(src.nativeObj, dst.nativeObj, alpha, beta, norm_type, dtype);
    ...
    public static void normalize(Mat src, Mat dst, double alpha, double beta, int norm_type)
    {
        ...
        n_normalize(src.nativeObj, dst.nativeObj, alpha, beta, norm_type);
    ...
    public static void normalize(Mat src, Mat dst, double alpha, double beta)
    {
        ...
        n_normalize(src.nativeObj, dst.nativeObj, alpha, beta);
    ...
    public static void normalize(Mat src, Mat dst, double alpha)
    {
        ...
        n_normalize(src.nativeObj, dst.nativeObj, alpha);
    ...
    public static void normalize(Mat src, Mat dst)
    {
        ...
        n_normalize(src.nativeObj, dst.nativeObj);
    ...
    public static void perspectiveTransform(Mat src, Mat dst, Mat m)
    {
        ...
        n_perspectiveTransform(src.nativeObj, dst.nativeObj, m.nativeObj);
    ...
    public static void phase(Mat x, Mat y, Mat angle, boolean angleInDegrees)
    {
        ...
        n_phase(x.nativeObj, y.nativeObj, angle.nativeObj, angleInDegrees);
    ...
    public static void phase(Mat x, Mat y, Mat angle)
    {
        ...
        n_phase(x.nativeObj, y.nativeObj, angle.nativeObj);
    ...
    public static void polarToCart(Mat magnitude, Mat angle, Mat x, Mat y, boolean angleInDegrees)
    {
        ...
        n_polarToCart(magnitude.nativeObj, angle.nativeObj, x.nativeObj, y.nativeObj, angleInDegrees);
    ...
    public static void polarToCart(Mat magnitude, Mat angle, Mat x, Mat y)
    {
        ...
        n_polarToCart(magnitude.nativeObj, angle.nativeObj, x.nativeObj, y.nativeObj);
    ...
    //
    // C++:  void polylines(Mat& arg1, vector_Mat pts, bool isClosed, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
    //
     ...
     */
    public static void polylines(Mat arg1, java.util.List<Mat> pts, boolean isClosed, Scalar color, int thickness, int lineType, int shift)
    {
        Mat pts_mat = utils.vector_Mat_to_Mat(pts);
        n_polylines(arg1.nativeObj, pts_mat.nativeObj, isClosed, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
     ...
     * @see <a href="http://opencv.itseez.com/modules/core/doc/drawing_functions.html#polylines">org.opencv.core.Core.polylines</a>
     */
    public static void polylines(Mat arg1, java.util.List<Mat> pts, boolean isClosed, Scalar color, int thickness, int lineType)
    {
        Mat pts_mat = utils.vector_Mat_to_Mat(pts);
        n_polylines(arg1.nativeObj, pts_mat.nativeObj, isClosed, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType);
     ...
     * @see <a href="http://opencv.itseez.com/modules/core/doc/drawing_functions.html#polylines">org.opencv.core.Core.polylines</a>
     */
    public static void polylines(Mat arg1, java.util.List<Mat> pts, boolean isClosed, Scalar color, int thickness)
    {
        Mat pts_mat = utils.vector_Mat_to_Mat(pts);
        n_polylines(arg1.nativeObj, pts_mat.nativeObj, isClosed, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
     ...
     * @see <a href="http://opencv.itseez.com/modules/core/doc/drawing_functions.html#polylines">org.opencv.core.Core.polylines</a>
     */
    public static void polylines(Mat arg1, java.util.List<Mat> pts, boolean isClosed, Scalar color)
    {
        Mat pts_mat = utils.vector_Mat_to_Mat(pts);
        n_polylines(arg1.nativeObj, pts_mat.nativeObj, isClosed, color.val[0], color.val[1], color.val[2], color.val[3]);
    ...
    public static void pow(Mat src, double power, Mat dst)
    {
        ...
        n_pow(src.nativeObj, power, dst.nativeObj);
    ...
    public static void putText(Mat img, java.lang.String text, Point org, int fontFace, double fontScale, Scalar color, int thickness, int linetype, boolean bottomLeftOrigin)
    {
        ...
        n_putText(img.nativeObj, text, org.x, org.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3], thickness, linetype, bottomLeftOrigin);
    ...
    public static void putText(Mat img, java.lang.String text, Point org, int fontFace, double fontScale, Scalar color, int thickness, int linetype)
    {
        ...
        n_putText(img.nativeObj, text, org.x, org.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3], thickness, linetype);
    ...
    public static void putText(Mat img, java.lang.String text, Point org, int fontFace, double fontScale, Scalar color, int thickness)
    {
        ...
        n_putText(img.nativeObj, text, org.x, org.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
    ...
    public static void putText(Mat img, java.lang.String text, Point org, int fontFace, double fontScale, Scalar color)
    {
        ...
        n_putText(img.nativeObj, text, org.x, org.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3]);
    ...
    public static void randShuffle(Mat dst, double iterFactor)
    {
        ...
        n_randShuffle(dst.nativeObj, iterFactor);
    ...
    //
    // C++:  void randn(Mat& dst, Mat mean, Mat stddev)
    //
    ...
    public static void randn(Mat dst, Mat mean, Mat stddev)
    {
        ...
        n_randn(dst.nativeObj, mean.nativeObj, stddev.nativeObj);
    ...
    //
    // C++:  void randu(Mat& dst, Mat low, Mat high)
    //
    ...
    public static void randu(Mat dst, Mat low, Mat high)
    {
        ...
        n_randu(dst.nativeObj, low.nativeObj, high.nativeObj);
    ...
    public static void rectangle(Mat img, Point pt1, Point pt2, Scalar color, int thickness, int lineType, int shift)
    {
        ...
        n_rectangle(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
    ...
    public static void rectangle(Mat img, Point pt1, Point pt2, Scalar color, int thickness, int lineType)
    {
        ...
        n_rectangle(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType);
    ...
    public static void rectangle(Mat img, Point pt1, Point pt2, Scalar color, int thickness)
    {
        ...
        n_rectangle(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
    ...
    public static void rectangle(Mat img, Point pt1, Point pt2, Scalar color)
    {
        ...
        n_rectangle(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3]);
    ...
    public static void reduce(Mat src, Mat dst, int dim, int rtype, int dtype)
    {
        ...
        n_reduce(src.nativeObj, dst.nativeObj, dim, rtype, dtype);
    ...
    public static void reduce(Mat src, Mat dst, int dim, int rtype)
    {
        ...
        n_reduce(src.nativeObj, dst.nativeObj, dim, rtype);
    ...
    public static void repeat(Mat src, int ny, int nx, Mat dst)
    {
        ...
        n_repeat(src.nativeObj, ny, nx, dst.nativeObj);
    ...
    public static void scaleAdd(Mat src1, double alpha, Mat src2, Mat dst)
    {
        ...
        n_scaleAdd(src1.nativeObj, alpha, src2.nativeObj, dst.nativeObj);
    ...
    public static void setIdentity(Mat mtx, Scalar s)
    {
        ...
        n_setIdentity(mtx.nativeObj, s.val[0], s.val[1], s.val[2], s.val[3]);
    ...
    public static boolean solve(Mat src1, Mat src2, Mat dst, int flags)
    {
        ...
        boolean retVal = n_solve(src1.nativeObj, src2.nativeObj, dst.nativeObj, flags);
    ...
    public static boolean solve(Mat src1, Mat src2, Mat dst)
    {
        ...
        boolean retVal = n_solve(src1.nativeObj, src2.nativeObj, dst.nativeObj);
    ...
    public static int solveCubic(Mat coeffs, Mat roots)
    {
        ...
        int retVal = n_solveCubic(coeffs.nativeObj, roots.nativeObj);
    ...
    public static double solvePoly(Mat coeffs, Mat roots, int maxIters)
    {
        ...
        double retVal = n_solvePoly(coeffs.nativeObj, roots.nativeObj, maxIters);
    ...
    public static double solvePoly(Mat coeffs, Mat roots)
    {
        ...
        double retVal = n_solvePoly(coeffs.nativeObj, roots.nativeObj);
    ...
    public static void sort(Mat src, Mat dst, int flags)
    {
        ...
        n_sort(src.nativeObj, dst.nativeObj, flags);
    ...
    public static void sortIdx(Mat src, Mat dst, int flags)
    {
        ...
        n_sortIdx(src.nativeObj, dst.nativeObj, flags);
    ...
    {
        Mat mv_mat = new Mat();
        n_split(m.nativeObj, mv_mat.nativeObj);
        utils.Mat_to_vector_Mat(mv_mat, mv);
        return;
    }
    ...
    public static void sqrt(Mat src, Mat dst)
    {
        ...
        n_sqrt(src.nativeObj, dst.nativeObj);
    ...
    public static void subtract(Mat src1, Mat src2, Mat dst, Mat mask, int dtype)
    {
        ...
        n_subtract(src1.nativeObj, src2.nativeObj, dst.nativeObj, mask.nativeObj, dtype);
    ...
    public static void subtract(Mat src1, Mat src2, Mat dst, Mat mask)
    {
        ...
        n_subtract(src1.nativeObj, src2.nativeObj, dst.nativeObj, mask.nativeObj);
    ...
    public static void subtract(Mat src1, Mat src2, Mat dst)
    {
        ...
        n_subtract(src1.nativeObj, src2.nativeObj, dst.nativeObj);
    ...
    public static Scalar sumElems(Mat src)
    {
        ...
        Scalar retVal = new Scalar(n_sumElems(src.nativeObj));
    ...
    public static Scalar trace(Mat mtx)
    {
        ...
        Scalar retVal = new Scalar(n_trace(mtx.nativeObj));
    ...
    public static void transform(Mat src, Mat dst, Mat m)
    {
        ...
        n_transform(src.nativeObj, dst.nativeObj, m.nativeObj);
    ...
    public static void transpose(Mat src, Mat dst)
    {
        ...
        n_transpose(src.nativeObj, dst.nativeObj);
    ...
    // C++:  void LUT(Mat src, Mat lut, Mat& dst, int interpolation = 0)
    private static native void n_LUT(long src_nativeObj, long lut_nativeObj, long dst_nativeObj, int interpolation);
    private static native void n_LUT(long src_nativeObj, long lut_nativeObj, long dst_nativeObj);

    // C++:  double Mahalanobis(Mat v1, Mat v2, Mat icovar)
    private static native double n_Mahalanobis(long v1_nativeObj, long v2_nativeObj, long icovar_nativeObj);

    // C++:  void PCABackProject(Mat data, Mat mean, Mat eigenvectors, Mat& result)
    private static native void n_PCABackProject(long data_nativeObj, long mean_nativeObj, long eigenvectors_nativeObj, long result_nativeObj);

    // C++:  void PCACompute(Mat data, Mat& mean, Mat& eigenvectors, int maxComponents = 0)
    private static native void n_PCACompute(long data_nativeObj, long mean_nativeObj, long eigenvectors_nativeObj, int maxComponents);
    private static native void n_PCACompute(long data_nativeObj, long mean_nativeObj, long eigenvectors_nativeObj);

    // C++:  void PCAProject(Mat data, Mat mean, Mat eigenvectors, Mat& result)
    private static native void n_PCAProject(long data_nativeObj, long mean_nativeObj, long eigenvectors_nativeObj, long result_nativeObj);

    // C++:  void SVBackSubst(Mat w, Mat u, Mat vt, Mat rhs, Mat& dst)
    private static native void n_SVBackSubst(long w_nativeObj, long u_nativeObj, long vt_nativeObj, long rhs_nativeObj, long dst_nativeObj);

    // C++:  void SVDecomp(Mat src, Mat& w, Mat& u, Mat& vt, int flags = 0)
    private static native void n_SVDecomp(long src_nativeObj, long w_nativeObj, long u_nativeObj, long vt_nativeObj, int flags);
    private static native void n_SVDecomp(long src_nativeObj, long w_nativeObj, long u_nativeObj, long vt_nativeObj);

    // C++:  void absdiff(Mat src1, Mat src2, Mat& dst)
    private static native void n_absdiff(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj);

    // C++:  void add(Mat src1, Mat src2, Mat& dst, Mat mask = Mat(), int dtype = -1)
    private static native void n_add(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, long mask_nativeObj, int dtype);
    private static native void n_add(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, long mask_nativeObj);
    private static native void n_add(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj);

    // C++:  void addWeighted(Mat src1, double alpha, Mat src2, double beta, double gamma, Mat& dst, int dtype = -1)
    private static native void n_addWeighted(long src1_nativeObj, double alpha, long src2_nativeObj, double beta, double gamma, long dst_nativeObj, int dtype);
    private static native void n_addWeighted(long src1_nativeObj, double alpha, long src2_nativeObj, double beta, double gamma, long dst_nativeObj);

    // C++:  void bitwise_and(Mat src1, Mat src2, Mat& dst, Mat mask = Mat())
    private static native void n_bitwise_and(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, long mask_nativeObj);
    private static native void n_bitwise_and(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj);

    // C++:  void bitwise_not(Mat src, Mat& dst, Mat mask = Mat())
    private static native void n_bitwise_not(long src_nativeObj, long dst_nativeObj, long mask_nativeObj);
    private static native void n_bitwise_not(long src_nativeObj, long dst_nativeObj);

    // C++:  void bitwise_or(Mat src1, Mat src2, Mat& dst, Mat mask = Mat())
    private static native void n_bitwise_or(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, long mask_nativeObj);
    private static native void n_bitwise_or(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj);

    // C++:  void bitwise_xor(Mat src1, Mat src2, Mat& dst, Mat mask = Mat())
    private static native void n_bitwise_xor(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, long mask_nativeObj);
    private static native void n_bitwise_xor(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj);

    // C++:  void calcCovarMatrix(Mat samples, Mat& covar, Mat& mean, int flags, int ctype = CV_64F)
    private static native void n_calcCovarMatrix(long samples_nativeObj, long covar_nativeObj, long mean_nativeObj, int flags, int ctype);
    private static native void n_calcCovarMatrix(long samples_nativeObj, long covar_nativeObj, long mean_nativeObj, int flags);

    // C++:  void cartToPolar(Mat x, Mat y, Mat& magnitude, Mat& angle, bool angleInDegrees = false)
    private static native void n_cartToPolar(long x_nativeObj, long y_nativeObj, long magnitude_nativeObj, long angle_nativeObj, boolean angleInDegrees);
    private static native void n_cartToPolar(long x_nativeObj, long y_nativeObj, long magnitude_nativeObj, long angle_nativeObj);

    // C++:  bool checkRange(Mat a, bool quiet = true, Point* pt = 0, double minVal = -DBL_MAX, double maxVal = DBL_MAX)
    private static native boolean n_checkRange(long a_nativeObj, boolean quiet, double[] pt_out, double minVal, double maxVal);
    private static native boolean n_checkRange(long a_nativeObj, boolean quiet, double[] pt_out, double minVal);
    private static native boolean n_checkRange(long a_nativeObj, boolean quiet, double[] pt_out);
    private static native boolean n_checkRange(long a_nativeObj, boolean quiet);
    private static native boolean n_checkRange(long a_nativeObj);

    // C++:  void circle(Mat img, Point center, int radius, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
    private static native void n_circle(long img_nativeObj, double center_x, double center_y, int radius, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);
    private static native void n_circle(long img_nativeObj, double center_x, double center_y, int radius, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType);
    private static native void n_circle(long img_nativeObj, double center_x, double center_y, int radius, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
    private static native void n_circle(long img_nativeObj, double center_x, double center_y, int radius, double color_val0, double color_val1, double color_val2, double color_val3);

    // C++:  bool clipLine(Rect imgRect, Point& pt1, Point& pt2)
    private static native boolean n_clipLine(int imgRect_x, int imgRect_y, int imgRect_width, int imgRect_height, double pt1_x, double pt1_y, double[] pt1_out, double pt2_x, double pt2_y, double[] pt2_out);

    // C++:  void compare(Mat src1, Mat src2, Mat& dst, int cmpop)
    private static native void n_compare(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, int cmpop);

    // C++:  void completeSymm(Mat& mtx, bool lowerToUpper = false)
    private static native void n_completeSymm(long mtx_nativeObj, boolean lowerToUpper);
    private static native void n_completeSymm(long mtx_nativeObj);

    // C++:  void convertScaleAbs(Mat src, Mat& dst, double alpha = 1, double beta = 0)
    private static native void n_convertScaleAbs(long src_nativeObj, long dst_nativeObj, double alpha, double beta);
    private static native void n_convertScaleAbs(long src_nativeObj, long dst_nativeObj, double alpha);
    private static native void n_convertScaleAbs(long src_nativeObj, long dst_nativeObj);

    // C++:  int countNonZero(Mat src)
    private static native int n_countNonZero(long src_nativeObj);

    // C++:  float cubeRoot(float val)
    private static native float n_cubeRoot(float val);

    // C++:  void dct(Mat src, Mat& dst, int flags = 0)
    private static native void n_dct(long src_nativeObj, long dst_nativeObj, int flags);
    private static native void n_dct(long src_nativeObj, long dst_nativeObj);

    // C++:  double determinant(Mat mtx)
    private static native double n_determinant(long mtx_nativeObj);

    // C++:  void dft(Mat src, Mat& dst, int flags = 0, int nonzeroRows = 0)
    private static native void n_dft(long src_nativeObj, long dst_nativeObj, int flags, int nonzeroRows);
    private static native void n_dft(long src_nativeObj, long dst_nativeObj, int flags);
    private static native void n_dft(long src_nativeObj, long dst_nativeObj);

    // C++:  void divide(Mat src1, Mat src2, Mat& dst, double scale = 1, int dtype = -1)
    private static native void n_divide(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, double scale, int dtype);
    private static native void n_divide(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, double scale);
    private static native void n_divide(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj);

    // C++:  void divide(double scale, Mat src2, Mat& dst, int dtype = -1)
    private static native void n_divide(double scale, long src2_nativeObj, long dst_nativeObj, int dtype);
    private static native void n_divide(double scale, long src2_nativeObj, long dst_nativeObj);

    // C++:  bool eigen(Mat src, bool computeEigenvectors, Mat& eigenvalues, Mat& eigenvectors)
    private static native boolean n_eigen(long src_nativeObj, boolean computeEigenvectors, long eigenvalues_nativeObj, long eigenvectors_nativeObj);

    // C++:  void ellipse(Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
    private static native void n_ellipse(long img_nativeObj, double center_x, double center_y, double axes_width, double axes_height, double angle, double startAngle, double endAngle, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);
    private static native void n_ellipse(long img_nativeObj, double center_x, double center_y, double axes_width, double axes_height, double angle, double startAngle, double endAngle, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType);
    private static native void n_ellipse(long img_nativeObj, double center_x, double center_y, double axes_width, double axes_height, double angle, double startAngle, double endAngle, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
    private static native void n_ellipse(long img_nativeObj, double center_x, double center_y, double axes_width, double axes_height, double angle, double startAngle, double endAngle, double color_val0, double color_val1, double color_val2, double color_val3);

    // C++:  void ellipse(Mat img, RotatedRect box, Scalar color, int thickness = 1, int lineType = 8)
    private static native void n_ellipse(long img_nativeObj, double box_center_x, double box_center_y, double box_size_width, double box_size_height, double box_angle, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType);
    private static native void n_ellipse(long img_nativeObj, double box_center_x, double box_center_y, double box_size_width, double box_size_height, double box_angle, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
    private static native void n_ellipse(long img_nativeObj, double box_center_x, double box_center_y, double box_size_width, double box_size_height, double box_angle, double color_val0, double color_val1, double color_val2, double color_val3);

    // C++:  void ellipse2Poly(Point center, Size axes, int angle, int arcStart, int arcEnd, int delta, vector_Point& pts)
    private static native void n_ellipse2Poly(double center_x, double center_y, double axes_width, double axes_height, int angle, int arcStart, int arcEnd, int delta, long pts_mat_nativeObj);

    // C++:  void exp(Mat src, Mat& dst)
    private static native void n_exp(long src_nativeObj, long dst_nativeObj);

    // C++:  void extractChannel(Mat src, Mat& dst, int coi)
    private static native void n_extractChannel(long src_nativeObj, long dst_nativeObj, int coi);

    // C++:  float fastAtan2(float y, float x)
    private static native float n_fastAtan2(float y, float x);

    // C++:  void fillConvexPoly(Mat& img, Mat points, Scalar color, int lineType = 8, int shift = 0)
    private static native void n_fillConvexPoly(long img_nativeObj, long points_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3, int lineType, int shift);
    private static native void n_fillConvexPoly(long img_nativeObj, long points_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3, int lineType);
    private static native void n_fillConvexPoly(long img_nativeObj, long points_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3);

    // C++:  void fillPoly(Mat& img, vector_Mat pts, Scalar color, int lineType = 8, int shift = 0, Point offset = Point())
    private static native void n_fillPoly(long img_nativeObj, long pts_mat_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3, int lineType, int shift, double offset_x, double offset_y);
    private static native void n_fillPoly(long img_nativeObj, long pts_mat_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3, int lineType, int shift);
    private static native void n_fillPoly(long img_nativeObj, long pts_mat_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3, int lineType);
    private static native void n_fillPoly(long img_nativeObj, long pts_mat_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3);

    // C++:  void flip(Mat src, Mat& dst, int flipCode)
    private static native void n_flip(long src_nativeObj, long dst_nativeObj, int flipCode);

    // C++:  void gemm(Mat src1, Mat src2, double alpha, Mat src3, double gamma, Mat& dst, int flags = 0)
    private static native void n_gemm(long src1_nativeObj, long src2_nativeObj, double alpha, long src3_nativeObj, double gamma, long dst_nativeObj, int flags);
    private static native void n_gemm(long src1_nativeObj, long src2_nativeObj, double alpha, long src3_nativeObj, double gamma, long dst_nativeObj);

    // C++:  int64 getCPUTickCount()
    private static native long n_getCPUTickCount();

    // C++:  int getOptimalDFTSize(int vecsize)
    private static native int n_getOptimalDFTSize(int vecsize);

    // C++:  int64 getTickCount()
    private static native long n_getTickCount();

    // C++:  double getTickFrequency()
    private static native double n_getTickFrequency();

    // C++:  void hconcat(Mat src, Mat& dst)
    private static native void n_hconcat(long src_nativeObj, long dst_nativeObj);

    // C++:  void idct(Mat src, Mat& dst, int flags = 0)
    private static native void n_idct(long src_nativeObj, long dst_nativeObj, int flags);
    private static native void n_idct(long src_nativeObj, long dst_nativeObj);

    // C++:  void idft(Mat src, Mat& dst, int flags = 0, int nonzeroRows = 0)
    private static native void n_idft(long src_nativeObj, long dst_nativeObj, int flags, int nonzeroRows);
    private static native void n_idft(long src_nativeObj, long dst_nativeObj, int flags);
    private static native void n_idft(long src_nativeObj, long dst_nativeObj);

    // C++:  void inRange(Mat src, Mat lowerb, Mat upperb, Mat& dst)
    private static native void n_inRange(long src_nativeObj, long lowerb_nativeObj, long upperb_nativeObj, long dst_nativeObj);

    // C++:  void insertChannel(Mat src, Mat& dst, int coi)
    private static native void n_insertChannel(long src_nativeObj, long dst_nativeObj, int coi);

    // C++:  double invert(Mat src, Mat& dst, int flags = DECOMP_LU)
    private static native double n_invert(long src_nativeObj, long dst_nativeObj, int flags);
    private static native double n_invert(long src_nativeObj, long dst_nativeObj);

    // C++:  double kmeans(Mat data, int K, Mat& bestLabels, TermCriteria criteria, int attempts, int flags, Mat& centers = Mat())
    private static native double n_kmeans(long data_nativeObj, int K, long bestLabels_nativeObj, int criteria_type, int criteria_maxCount, double criteria_epsilon, int attempts, int flags, long centers_nativeObj);
    private static native double n_kmeans(long data_nativeObj, int K, long bestLabels_nativeObj, int criteria_type, int criteria_maxCount, double criteria_epsilon, int attempts, int flags);

    // C++:  void line(Mat img, Point pt1, Point pt2, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
    private static native void n_line(long img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);
    private static native void n_line(long img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType);
    private static native void n_line(long img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
    private static native void n_line(long img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3);

    // C++:  void log(Mat src, Mat& dst)
    private static native void n_log(long src_nativeObj, long dst_nativeObj);

    // C++:  void magnitude(Mat x, Mat y, Mat& magnitude)
    private static native void n_magnitude(long x_nativeObj, long y_nativeObj, long magnitude_nativeObj);

    // C++:  void max(Mat src1, Mat src2, Mat& dst)
    private static native void n_max(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj);

    // C++:  Scalar mean(Mat src, Mat mask = Mat())
    private static native double[] n_mean(long src_nativeObj, long mask_nativeObj);
    private static native double[] n_mean(long src_nativeObj);

    // C++:  void meanStdDev(Mat src, Mat& mean, Mat& stddev, Mat mask = Mat())
    private static native void n_meanStdDev(long src_nativeObj, long mean_nativeObj, long stddev_nativeObj, long mask_nativeObj);
    private static native void n_meanStdDev(long src_nativeObj, long mean_nativeObj, long stddev_nativeObj);

    // C++:  void merge(vector_Mat mv, Mat& dst)
    private static native void n_merge(long mv_mat_nativeObj, long dst_nativeObj);

    // C++:  void min(Mat src1, Mat src2, Mat& dst)
    private static native void n_min(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj);

    // C++:  void mixChannels(vector_Mat src, vector_Mat& dst, vector_int fromTo)
    private static native void n_mixChannels(long src_mat_nativeObj, long dst_mat_nativeObj, long fromTo_mat_nativeObj);

    // C++:  void mulSpectrums(Mat a, Mat b, Mat& c, int flags, bool conjB = false)
    private static native void n_mulSpectrums(long a_nativeObj, long b_nativeObj, long c_nativeObj, int flags, boolean conjB);
    private static native void n_mulSpectrums(long a_nativeObj, long b_nativeObj, long c_nativeObj, int flags);

    // C++:  void mulTransposed(Mat src, Mat& dst, bool aTa, Mat delta = Mat(), double scale = 1, int dtype = -1)
    private static native void n_mulTransposed(long src_nativeObj, long dst_nativeObj, boolean aTa, long delta_nativeObj, double scale, int dtype);
    private static native void n_mulTransposed(long src_nativeObj, long dst_nativeObj, boolean aTa, long delta_nativeObj, double scale);
    private static native void n_mulTransposed(long src_nativeObj, long dst_nativeObj, boolean aTa, long delta_nativeObj);
    private static native void n_mulTransposed(long src_nativeObj, long dst_nativeObj, boolean aTa);

    // C++:  void multiply(Mat src1, Mat src2, Mat& dst, double scale = 1, int dtype = -1)
    private static native void n_multiply(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, double scale, int dtype);
    private static native void n_multiply(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, double scale);
    private static native void n_multiply(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj);

    // C++:  double norm(Mat src1, int normType = NORM_L2, Mat mask = Mat())
    private static native double n_norm(long src1_nativeObj, int normType, long mask_nativeObj);
    private static native double n_norm(long src1_nativeObj, int normType);
    private static native double n_norm(long src1_nativeObj);

    // C++:  double norm(Mat src1, Mat src2, int normType = NORM_L2, Mat mask = Mat())
    private static native double n_norm(long src1_nativeObj, long src2_nativeObj, int normType, long mask_nativeObj);
    private static native double n_norm(long src1_nativeObj, long src2_nativeObj, int normType);
    private static native double n_norm(long src1_nativeObj, long src2_nativeObj);

    // C++:  void normalize(Mat src, Mat& dst, double alpha = 1, double beta = 0, int norm_type = NORM_L2, int dtype = -1, Mat mask = Mat())
    private static native void n_normalize(long src_nativeObj, long dst_nativeObj, double alpha, double beta, int norm_type, int dtype, long mask_nativeObj);
    private static native void n_normalize(long src_nativeObj, long dst_nativeObj, double alpha, double beta, int norm_type, int dtype);
    private static native void n_normalize(long src_nativeObj, long dst_nativeObj, double alpha, double beta, int norm_type);
    private static native void n_normalize(long src_nativeObj, long dst_nativeObj, double alpha, double beta);
    private static native void n_normalize(long src_nativeObj, long dst_nativeObj, double alpha);
    private static native void n_normalize(long src_nativeObj, long dst_nativeObj);

    // C++:  void perspectiveTransform(Mat src, Mat& dst, Mat m)
    private static native void n_perspectiveTransform(long src_nativeObj, long dst_nativeObj, long m_nativeObj);

    // C++:  void phase(Mat x, Mat y, Mat& angle, bool angleInDegrees = false)
    private static native void n_phase(long x_nativeObj, long y_nativeObj, long angle_nativeObj, boolean angleInDegrees);
    private static native void n_phase(long x_nativeObj, long y_nativeObj, long angle_nativeObj);

    // C++:  void polarToCart(Mat magnitude, Mat angle, Mat& x, Mat& y, bool angleInDegrees = false)
    private static native void n_polarToCart(long magnitude_nativeObj, long angle_nativeObj, long x_nativeObj, long y_nativeObj, boolean angleInDegrees);
    private static native void n_polarToCart(long magnitude_nativeObj, long angle_nativeObj, long x_nativeObj, long y_nativeObj);

    // C++:  void polylines(Mat& arg1, vector_Mat pts, bool isClosed, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
    private static native void n_polylines(long arg1_nativeObj, long pts_mat_nativeObj, boolean isClosed, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);
    private static native void n_polylines(long arg1_nativeObj, long pts_mat_nativeObj, boolean isClosed, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType);
    private static native void n_polylines(long arg1_nativeObj, long pts_mat_nativeObj, boolean isClosed, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
    private static native void n_polylines(long arg1_nativeObj, long pts_mat_nativeObj, boolean isClosed, double color_val0, double color_val1, double color_val2, double color_val3);

    // C++:  void pow(Mat src, double power, Mat& dst)
    private static native void n_pow(long src_nativeObj, double power, long dst_nativeObj);

    // C++:  void putText(Mat img, string text, Point org, int fontFace, double fontScale, Scalar color, int thickness = 1, int linetype = 8, bool bottomLeftOrigin = false)
    private static native void n_putText(long img_nativeObj, java.lang.String text, double org_x, double org_y, int fontFace, double fontScale, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int linetype, boolean bottomLeftOrigin);
    private static native void n_putText(long img_nativeObj, java.lang.String text, double org_x, double org_y, int fontFace, double fontScale, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int linetype);
    private static native void n_putText(long img_nativeObj, java.lang.String text, double org_x, double org_y, int fontFace, double fontScale, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
    private static native void n_putText(long img_nativeObj, java.lang.String text, double org_x, double org_y, int fontFace, double fontScale, double color_val0, double color_val1, double color_val2, double color_val3);

    // C++:  void randShuffle_(Mat& dst, double iterFactor = 1.)
    private static native void n_randShuffle(long dst_nativeObj, double iterFactor);
    private static native void n_randShuffle(long dst_nativeObj);

    // C++:  void randn(Mat& dst, Mat mean, Mat stddev)
    private static native void n_randn(long dst_nativeObj, long mean_nativeObj, long stddev_nativeObj);

    // C++:  void randu(Mat& dst, Mat low, Mat high)
    private static native void n_randu(long dst_nativeObj, long low_nativeObj, long high_nativeObj);

    // C++:  void rectangle(Mat img, Point pt1, Point pt2, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
    private static native void n_rectangle(long img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);
    private static native void n_rectangle(long img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType);
    private static native void n_rectangle(long img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
    private static native void n_rectangle(long img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3);

    // C++:  void reduce(Mat src, Mat& dst, int dim, int rtype, int dtype = -1)
    private static native void n_reduce(long src_nativeObj, long dst_nativeObj, int dim, int rtype, int dtype);
    private static native void n_reduce(long src_nativeObj, long dst_nativeObj, int dim, int rtype);

    // C++:  void repeat(Mat src, int ny, int nx, Mat& dst)
    private static native void n_repeat(long src_nativeObj, int ny, int nx, long dst_nativeObj);

    // C++:  void scaleAdd(Mat src1, double alpha, Mat src2, Mat& dst)
    private static native void n_scaleAdd(long src1_nativeObj, double alpha, long src2_nativeObj, long dst_nativeObj);

    // C++:  void setIdentity(Mat& mtx, Scalar s = Scalar(1))
    private static native void n_setIdentity(long mtx_nativeObj, double s_val0, double s_val1, double s_val2, double s_val3);
    private static native void n_setIdentity(long mtx_nativeObj);

    // C++:  bool solve(Mat src1, Mat src2, Mat& dst, int flags = DECOMP_LU)
    private static native boolean n_solve(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, int flags);
    private static native boolean n_solve(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj);

    // C++:  int solveCubic(Mat coeffs, Mat& roots)
    private static native int n_solveCubic(long coeffs_nativeObj, long roots_nativeObj);

    // C++:  double solvePoly(Mat coeffs, Mat& roots, int maxIters = 300)
    private static native double n_solvePoly(long coeffs_nativeObj, long roots_nativeObj, int maxIters);
    private static native double n_solvePoly(long coeffs_nativeObj, long roots_nativeObj);

    // C++:  void sort(Mat src, Mat& dst, int flags)
    private static native void n_sort(long src_nativeObj, long dst_nativeObj, int flags);

    // C++:  void sortIdx(Mat src, Mat& dst, int flags)
    private static native void n_sortIdx(long src_nativeObj, long dst_nativeObj, int flags);

    // C++:  void split(Mat m, vector_Mat& mv)
    private static native void n_split(long m_nativeObj, long mv_mat_nativeObj);

    // C++:  void sqrt(Mat src, Mat& dst)
    private static native void n_sqrt(long src_nativeObj, long dst_nativeObj);

    // C++:  void subtract(Mat src1, Mat src2, Mat& dst, Mat mask = Mat(), int dtype = -1)
    private static native void n_subtract(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, long mask_nativeObj, int dtype);
    private static native void n_subtract(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj, long mask_nativeObj);
    private static native void n_subtract(long src1_nativeObj, long src2_nativeObj, long dst_nativeObj);

    // C++:  Scalar sum(Mat src)
    private static native double[] n_sumElems(long src_nativeObj);

    // C++:  Scalar trace(Mat mtx)
    private static native double[] n_trace(long mtx_nativeObj);

    // C++:  void transform(Mat src, Mat& dst, Mat m)
    private static native void n_transform(long src_nativeObj, long dst_nativeObj, long m_nativeObj);

    // C++:  void transpose(Mat src, Mat& dst)
    private static native void n_transpose(long src_nativeObj, long dst_nativeObj);
