...
public class StereoBM {
    ...
    public   StereoBM(int preset, int ndisparities, int SADWindowSize)
    {
        ...
        nativeObj = n_StereoBM(preset, ndisparities, SADWindowSize);
    ...
    public   StereoBM(int preset, int ndisparities)
    {
        ...
        nativeObj = n_StereoBM(preset, ndisparities);
    ...
    public  void compute(Mat left, Mat right, Mat disparity, int disptype)
    {
        ...
        n_compute(nativeObj, left.nativeObj, right.nativeObj, disparity.nativeObj, disptype);
    ...
    public  void compute(Mat left, Mat right, Mat disparity)
    {
        ...
        n_compute(nativeObj, left.nativeObj, right.nativeObj, disparity.nativeObj);
    ...
    // C++:   StereoBM::StereoBM()
    private static native long n_StereoBM();

    // C++:   StereoBM::StereoBM(int preset, int ndisparities = 0, int SADWindowSize = 21)
    private static native long n_StereoBM(int preset, int ndisparities, int SADWindowSize);
    private static native long n_StereoBM(int preset, int ndisparities);
    private static native long n_StereoBM(int preset);

    // C++:  void StereoBM::operator()(Mat left, Mat right, Mat& disparity, int disptype = CV_16S)
    private static native void n_compute(long nativeObj, long left_nativeObj, long right_nativeObj, long disparity_nativeObj, int disptype);
    private static native void n_compute(long nativeObj, long left_nativeObj, long right_nativeObj, long disparity_nativeObj);
