 ...
 * <p/>
 * Alterations:
 * Added updateCheckedEntryIndexes call in onPrepareDialogBuilder to fix persistence bug.
 */
/**
 * Alterations:
 * Added updateCheckedEntryIndexes call in onPrepareDialogBuilder to fix persistence bug.
...
public class MultiSelectListPreference extends ListPreference {
   ...
   @Override protected void onPrepareDialogBuilder(Builder builder) {
      updateCheckedEntryIndexes();
      builder
          .setMultiChoiceItems(getEntries(), checkedEntryIndexes, new OnMultiChoiceClickListener() {
   ...
   @Override protected void onDialogClosed(boolean positiveResult) {
      if (positiveResult) {
         ...
         String val = toPersistedPreferenceValue(
             checkedVals.toArray(new CharSequence[checkedVals.size()]));
